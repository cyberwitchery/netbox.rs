...
> {
    ...
    local_var_req_builder = local_var_req_builder.json(&patched_bulk_virtual_machine_request);
...
) -> Result<Vec<crate::models::VirtualMachine>, Error<VirtualizationVirtualMachinesBulkUpdateError>>
{
    ...
    local_var_req_builder = local_var_req_builder.json(&bulk_virtual_machine_request);
...
pub async fn virtualization_virtual_machines_partial_update(
    ...
    local_var_req_builder = local_var_req_builder.json(&patched_writable_virtual_machine_request);
...
pub async fn virtualization_virtual_machines_update(
    ...
    local_var_req_builder = local_var_req_builder.json(&writable_virtual_machine_request);
