...
pub async fn core_data_sources_bulk_partial_update(
    ...
    local_var_req_builder = local_var_req_builder.json(&patched_bulk_data_source_request);
...
pub async fn core_data_sources_bulk_update(
    ...
    local_var_req_builder = local_var_req_builder.json(&bulk_data_source_request);
...
pub async fn core_data_sources_create(
    ...
    local_var_req_builder = local_var_req_builder.json(&core_data_sources_create_request);
...
pub async fn core_jobs_list(
    ...
    if let Some(ref local_var_str) = execution_time {
        local_var_req_builder =
            local_var_req_builder.query(&[("execution_time", &local_var_str.to_string())]);
    }
    if let Some(ref local_var_str) = execution_time__gte {
        local_var_req_builder =
            local_var_req_builder.query(&[("execution_time__gte", &local_var_str.to_string())]);
    }
    if let Some(ref local_var_str) = execution_time__lte {
        local_var_req_builder =
            local_var_req_builder.query(&[("execution_time__lte", &local_var_str.to_string())]);
    }
    if let Some(ref local_var_str) = fields {
        local_var_req_builder =
            local_var_req_builder.query(&[("fields", &local_var_str.to_string())]);
    ...
    if let Some(ref local_var_str) = notifications {
        local_var_req_builder = match "multi" {
            "multi" => local_var_req_builder.query(
                &local_var_str
                    .into_iter()
                    .map(|p| ("notifications".to_owned(), p.to_string()))
                    .collect::<Vec<(std::string::String, std::string::String)>>(),
            ),
            _ => local_var_req_builder.query(&[(
                "notifications",
    ...
    if let Some(ref local_var_str) = notifications__empty {
        local_var_req_builder =
            local_var_req_builder.query(&[("notifications__empty", &local_var_str.to_string())]);
    }
    if let Some(ref local_var_str) = notifications__ic {
        local_var_req_builder = match "multi" {
            "multi" => local_var_req_builder.query(
                &local_var_str
                    .into_iter()
                    .map(|p| ("notifications__ic".to_owned(), p.to_string()))
                    .collect::<Vec<(std::string::String, std::string::String)>>(),
            ),
            _ => local_var_req_builder.query(&[(
                "notifications__ic",
    ...
    if let Some(ref local_var_str) = notifications__ie {
        local_var_req_builder = match "multi" {
            "multi" => local_var_req_builder.query(
                &local_var_str
                    .into_iter()
                    .map(|p| ("notifications__ie".to_owned(), p.to_string()))
                    .collect::<Vec<(std::string::String, std::string::String)>>(),
            ),
            _ => local_var_req_builder.query(&[(
                "notifications__ie",
    ...
    if let Some(ref local_var_str) = notifications__iew {
        local_var_req_builder = match "multi" {
            "multi" => local_var_req_builder.query(
                &local_var_str
                    .into_iter()
                    .map(|p| ("notifications__iew".to_owned(), p.to_string()))
                    .collect::<Vec<(std::string::String, std::string::String)>>(),
            ),
            _ => local_var_req_builder.query(&[(
                "notifications__iew",
    ...
    if let Some(ref local_var_str) = notifications__iregex {
        local_var_req_builder = match "multi" {
            "multi" => local_var_req_builder.query(
                &local_var_str
                    .into_iter()
                    .map(|p| ("notifications__iregex".to_owned(), p.to_string()))
                    .collect::<Vec<(std::string::String, std::string::String)>>(),
            ),
            _ => local_var_req_builder.query(&[(
                "notifications__iregex",
                &local_var_str
                    .into_iter()
                    .map(|p| p.to_string())
                    .collect::<Vec<String>>()
    ...
    if let Some(ref local_var_str) = notifications__isw {
        local_var_req_builder = match "multi" {
            "multi" => local_var_req_builder.query(
                &local_var_str
                    .into_iter()
                    .map(|p| ("notifications__isw".to_owned(), p.to_string()))
                    .collect::<Vec<(std::string::String, std::string::String)>>(),
            ),
            _ => local_var_req_builder.query(&[(
                "notifications__isw",
    ...
    if let Some(ref local_var_str) = notifications__n {
        local_var_req_builder = match "multi" {
            "multi" => local_var_req_builder.query(
                &local_var_str
                    .into_iter()
                    .map(|p| ("notifications__n".to_owned(), p.to_string()))
                    .collect::<Vec<(std::string::String, std::string::String)>>(),
            ),
            _ => local_var_req_builder.query(&[(
                "notifications__n",
    ...
    if let Some(ref local_var_str) = notifications__nic {
        local_var_req_builder = match "multi" {
            "multi" => local_var_req_builder.query(
                &local_var_str
                    .into_iter()
                    .map(|p| ("notifications__nic".to_owned(), p.to_string()))
                    .collect::<Vec<(std::string::String, std::string::String)>>(),
            ),
            _ => local_var_req_builder.query(&[(
                "notifications__nic",
    ...
    if let Some(ref local_var_str) = notifications__nie {
        local_var_req_builder = match "multi" {
            "multi" => local_var_req_builder.query(
                &local_var_str
                    .into_iter()
                    .map(|p| ("notifications__nie".to_owned(), p.to_string()))
                    .collect::<Vec<(std::string::String, std::string::String)>>(),
            ),
            _ => local_var_req_builder.query(&[(
                "notifications__nie",
    ...
    if let Some(ref local_var_str) = notifications__niew {
        local_var_req_builder = match "multi" {
            "multi" => local_var_req_builder.query(
                &local_var_str
                    .into_iter()
                    .map(|p| ("notifications__niew".to_owned(), p.to_string()))
                    .collect::<Vec<(std::string::String, std::string::String)>>(),
            ),
            _ => local_var_req_builder.query(&[(
                "notifications__niew",
    ...
    if let Some(ref local_var_str) = notifications__nisw {
        local_var_req_builder = match "multi" {
            "multi" => local_var_req_builder.query(
                &local_var_str
                    .into_iter()
                    .map(|p| ("notifications__nisw".to_owned(), p.to_string()))
                    .collect::<Vec<(std::string::String, std::string::String)>>(),
            ),
            _ => local_var_req_builder.query(&[(
                "notifications__nisw",
    ...
    if let Some(ref local_var_str) = notifications__regex {
        local_var_req_builder = match "multi" {
            "multi" => local_var_req_builder.query(
                &local_var_str
                    .into_iter()
                    .map(|p| ("notifications__regex".to_owned(), p.to_string()))
                    .collect::<Vec<(std::string::String, std::string::String)>>(),
            ),
            _ => local_var_req_builder.query(&[(
                "notifications__regex",
                &local_var_str
                    .into_iter()
                    .map(|p| p.to_string())
                    .collect::<Vec<String>>()
    ...
    if let Some(ref local_var_str) = queue_name {
        local_var_req_builder =
            local_var_req_builder.query(&[("queue_name", &local_var_str.to_string())]);
    }
    if let Some(ref local_var_str) = queue_name__empty {
        local_var_req_builder =
            local_var_req_builder.query(&[("queue_name__empty", &local_var_str.to_string())]);
    }
    if let Some(ref local_var_str) = queue_name__ic {
        local_var_req_builder =
            local_var_req_builder.query(&[("queue_name__ic", &local_var_str.to_string())]);
    }
    if let Some(ref local_var_str) = queue_name__ie {
        local_var_req_builder =
            local_var_req_builder.query(&[("queue_name__ie", &local_var_str.to_string())]);
    }
    if let Some(ref local_var_str) = queue_name__iew {
        local_var_req_builder =
            local_var_req_builder.query(&[("queue_name__iew", &local_var_str.to_string())]);
    }
    if let Some(ref local_var_str) = queue_name__iregex {
        local_var_req_builder =
            local_var_req_builder.query(&[("queue_name__iregex", &local_var_str.to_string())]);
    }
    if let Some(ref local_var_str) = queue_name__isw {
        local_var_req_builder =
            local_var_req_builder.query(&[("queue_name__isw", &local_var_str.to_string())]);
    }
    if let Some(ref local_var_str) = queue_name__n {
        local_var_req_builder =
            local_var_req_builder.query(&[("queue_name__n", &local_var_str.to_string())]);
    }
    if let Some(ref local_var_str) = queue_name__nic {
        local_var_req_builder =
            local_var_req_builder.query(&[("queue_name__nic", &local_var_str.to_string())]);
    }
    if let Some(ref local_var_str) = queue_name__nie {
        local_var_req_builder =
            local_var_req_builder.query(&[("queue_name__nie", &local_var_str.to_string())]);
    }
    if let Some(ref local_var_str) = queue_name__niew {
        local_var_req_builder =
            local_var_req_builder.query(&[("queue_name__niew", &local_var_str.to_string())]);
    }
    if let Some(ref local_var_str) = queue_name__nisw {
        local_var_req_builder =
            local_var_req_builder.query(&[("queue_name__nisw", &local_var_str.to_string())]);
    }
    if let Some(ref local_var_str) = queue_name__regex {
        local_var_req_builder =
            local_var_req_builder.query(&[("queue_name__regex", &local_var_str.to_string())]);
    }
    ...
    if let Some(ref local_var_str) = changed_object_type {
        local_var_req_builder = match "multi" {
            "multi" => local_var_req_builder.query(
                &local_var_str
                    .into_iter()
                    .map(|p| ("changed_object_type".to_owned(), p.to_string()))
                    .collect::<Vec<(std::string::String, std::string::String)>>(),
            ),
            _ => local_var_req_builder.query(&[(
                "changed_object_type",
    ...
    if let Some(ref local_var_str) = changed_object_type__n {
        local_var_req_builder = match "multi" {
            "multi" => local_var_req_builder.query(
                &local_var_str
                    .into_iter()
                    .map(|p| ("changed_object_type__n".to_owned(), p.to_string()))
                    .collect::<Vec<(std::string::String, std::string::String)>>(),
            ),
            _ => local_var_req_builder.query(&[(
    ...
    if let Some(ref local_var_str) = related_object_type {
        local_var_req_builder = match "multi" {
            "multi" => local_var_req_builder.query(
                &local_var_str
                    .into_iter()
                    .map(|p| ("related_object_type".to_owned(), p.to_string()))
                    .collect::<Vec<(std::string::String, std::string::String)>>(),
            ),
            _ => local_var_req_builder.query(&[(
                "related_object_type",
    ...
    if let Some(ref local_var_str) = related_object_type__n {
        local_var_req_builder = match "multi" {
            "multi" => local_var_req_builder.query(
                &local_var_str
                    .into_iter()
                    .map(|p| ("related_object_type__n".to_owned(), p.to_string()))
                    .collect::<Vec<(std::string::String, std::string::String)>>(),
            ),
            _ => local_var_req_builder.query(&[(
