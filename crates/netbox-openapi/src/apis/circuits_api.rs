...
pub async fn circuits_circuit_group_assignments_bulk_destroy(configuration: &configuration::Configuration, circuit_group_assignment_request: Vec<crate::models::CircuitGroupAssignmentRequest>) -> Result<(), Error<CircuitsCircuitGroupAssignmentsBulkDestroyError>> {
    let local_var_configuration = configuration;

    let local_var_client = &local_var_configuration.client;

    let local_var_uri_str = format!("{}/api/circuits/circuit-group-assignments/", local_var_configuration.base_path);
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<CircuitsCircuitGroupAssignmentsBulkDestroyError> = serde_json::from_str(&local_var_content).ok();
...
pub async fn circuits_circuit_group_assignments_bulk_partial_update(configuration: &configuration::Configuration, circuit_group_assignment_request: Vec<crate::models::CircuitGroupAssignmentRequest>) -> Result<Vec<crate::models::CircuitGroupAssignment>, Error<CircuitsCircuitGroupAssignmentsBulkPartialUpdateError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<CircuitsCircuitGroupAssignmentsBulkPartialUpdateError> = serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Err(Error::ResponseError(local_var_error))
    }
}
...
pub async fn circuits_circuit_group_assignments_bulk_update(configuration: &configuration::Configuration, circuit_group_assignment_request: Vec<crate::models::CircuitGroupAssignmentRequest>) -> Result<Vec<crate::models::CircuitGroupAssignment>, Error<CircuitsCircuitGroupAssignmentsBulkUpdateError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<CircuitsCircuitGroupAssignmentsBulkUpdateError> = serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Err(Error::ResponseError(local_var_error))
    }
}
...
pub async fn circuits_circuit_group_assignments_create(configuration: &configuration::Configuration, writable_circuit_group_assignment_request: crate::models::WritableCircuitGroupAssignmentRequest) -> Result<crate::models::CircuitGroupAssignment, Error<CircuitsCircuitGroupAssignmentsCreateError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<CircuitsCircuitGroupAssignmentsCreateError> = serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Err(Error::ResponseError(local_var_error))
    }
}
...
pub async fn circuits_circuit_group_assignments_destroy(configuration: &configuration::Configuration, id: i32) -> Result<(), Error<CircuitsCircuitGroupAssignmentsDestroyError>> {
    let local_var_configuration = configuration;

    let local_var_client = &local_var_configuration.client;

    let local_var_uri_str = format!("{}/api/circuits/circuit-group-assignments/{id}/", local_var_configuration.base_path, id=id);
    let mut local_var_req_builder = local_var_client.request(reqwest::Method::DELETE, local_var_uri_str.as_str());
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<CircuitsCircuitGroupAssignmentsDestroyError> = serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Err(Error::ResponseError(local_var_error))
    }
}
...
pub async fn circuits_circuit_group_assignments_list(configuration: &configuration::Configuration, circuit: Option<Vec<String>>, circuit_id: Option<Vec<i32>>, created: Option<Vec<String>>, created__empty: Option<Vec<String>>, created__gt: Option<Vec<String>>, created__gte: Option<Vec<String>>, created__lt: Option<Vec<String>>, created__lte: Option<Vec<String>>, created__n: Option<Vec<String>>, created_by_request: Option<&str>, group: Option<Vec<String>>, group__n: Option<Vec<String>>, group_id: Option<Vec<i32>>, group_id__n: Option<Vec<i32>>, id: Option<Vec<i32>>, id__empty: Option<bool>, id__gt: Option<Vec<i32>>, id__gte: Option<Vec<i32>>, id__lt: Option<Vec<i32>>, id__lte: Option<Vec<i32>>, id__n: Option<Vec<i32>>, last_updated: Option<Vec<String>>, last_updated__empty: Option<Vec<String>>, last_updated__gt: Option<Vec<String>>, last_updated__gte: Option<Vec<String>>, last_updated__lt: Option<Vec<String>>, last_updated__lte: Option<Vec<String>>, last_updated__n: Option<Vec<String>>, limit: Option<i32>, member_id: Option<Vec<i32>>, member_id__empty: Option<bool>, member_id__gt: Option<Vec<i32>>, member_id__gte: Option<Vec<i32>>, member_id__lt: Option<Vec<i32>>, member_id__lte: Option<Vec<i32>>, member_id__n: Option<Vec<i32>>, member_type: Option<&str>, member_type__n: Option<&str>, modified_by_request: Option<&str>, offset: Option<i32>, ordering: Option<&str>, priority: Option<&str>, provider: Option<Vec<String>>, provider_id: Option<Vec<i32>>, q: Option<&str>, tag: Option<Vec<String>>, tag__n: Option<Vec<String>>, tag_id: Option<Vec<i32>>, tag_id__n: Option<Vec<i32>>, updated_by_request: Option<&str>, virtual_circuit: Option<Vec<String>>, virtual_circuit_id: Option<Vec<i32>>) -> Result<crate::models::PaginatedCircuitGroupAssignmentList, Error<CircuitsCircuitGroupAssignmentsListError>> {
    let local_var_configuration = configuration;
    ...
    if let Some(ref local_var_str) = circuit {
        local_var_req_builder = match "multi" {
            "multi" => local_var_req_builder.query(&local_var_str.into_iter().map(|p| ("circuit".to_owned(), p.to_string())).collect::<Vec<(std::string::String, std::string::String)>>()),
            _ => local_var_req_builder.query(&[("circuit", &local_var_str.into_iter().map(|p| p.to_string()).collect::<Vec<String>>().join(",").to_string())]),
        };
    }
    ...
    if let Some(ref local_var_str) = member_id {
        local_var_req_builder = match "multi" {
            "multi" => local_var_req_builder.query(&local_var_str.into_iter().map(|p| ("member_id".to_owned(), p.to_string())).collect::<Vec<(std::string::String, std::string::String)>>()),
            _ => local_var_req_builder.query(&[("member_id", &local_var_str.into_iter().map(|p| p.to_string()).collect::<Vec<String>>().join(",").to_string())]),
        };
    }
    if let Some(ref local_var_str) = member_id__empty {
        local_var_req_builder = local_var_req_builder.query(&[("member_id__empty", &local_var_str.to_string())]);
    }
    if let Some(ref local_var_str) = member_id__gt {
        local_var_req_builder = match "multi" {
            "multi" => local_var_req_builder.query(&local_var_str.into_iter().map(|p| ("member_id__gt".to_owned(), p.to_string())).collect::<Vec<(std::string::String, std::string::String)>>()),
            _ => local_var_req_builder.query(&[("member_id__gt", &local_var_str.into_iter().map(|p| p.to_string()).collect::<Vec<String>>().join(",").to_string())]),
        };
    }
    if let Some(ref local_var_str) = member_id__gte {
        local_var_req_builder = match "multi" {
            "multi" => local_var_req_builder.query(&local_var_str.into_iter().map(|p| ("member_id__gte".to_owned(), p.to_string())).collect::<Vec<(std::string::String, std::string::String)>>()),
            _ => local_var_req_builder.query(&[("member_id__gte", &local_var_str.into_iter().map(|p| p.to_string()).collect::<Vec<String>>().join(",").to_string())]),
        };
    }
    if let Some(ref local_var_str) = member_id__lt {
        local_var_req_builder = match "multi" {
            "multi" => local_var_req_builder.query(&local_var_str.into_iter().map(|p| ("member_id__lt".to_owned(), p.to_string())).collect::<Vec<(std::string::String, std::string::String)>>()),
            _ => local_var_req_builder.query(&[("member_id__lt", &local_var_str.into_iter().map(|p| p.to_string()).collect::<Vec<String>>().join(",").to_string())]),
        };
    }
    if let Some(ref local_var_str) = member_id__lte {
        local_var_req_builder = match "multi" {
            "multi" => local_var_req_builder.query(&local_var_str.into_iter().map(|p| ("member_id__lte".to_owned(), p.to_string())).collect::<Vec<(std::string::String, std::string::String)>>()),
            _ => local_var_req_builder.query(&[("member_id__lte", &local_var_str.into_iter().map(|p| p.to_string()).collect::<Vec<String>>().join(",").to_string())]),
        };
    }
    if let Some(ref local_var_str) = member_id__n {
        local_var_req_builder = match "multi" {
            "multi" => local_var_req_builder.query(&local_var_str.into_iter().map(|p| ("member_id__n".to_owned(), p.to_string())).collect::<Vec<(std::string::String, std::string::String)>>()),
            _ => local_var_req_builder.query(&[("member_id__n", &local_var_str.into_iter().map(|p| p.to_string()).collect::<Vec<String>>().join(",").to_string())]),
        };
    }
    if let Some(ref local_var_str) = member_type {
        local_var_req_builder = local_var_req_builder.query(&[("member_type", &local_var_str.to_string())]);
    }
    if let Some(ref local_var_str) = member_type__n {
        local_var_req_builder = local_var_req_builder.query(&[("member_type__n", &local_var_str.to_string())]);
    }
    ...
    if let Some(ref local_var_str) = virtual_circuit {
        local_var_req_builder = match "multi" {
            "multi" => local_var_req_builder.query(&local_var_str.into_iter().map(|p| ("virtual_circuit".to_owned(), p.to_string())).collect::<Vec<(std::string::String, std::string::String)>>()),
            _ => local_var_req_builder.query(&[("virtual_circuit", &local_var_str.into_iter().map(|p| p.to_string()).collect::<Vec<String>>().join(",").to_string())]),
        };
    }
    if let Some(ref local_var_str) = virtual_circuit_id {
        local_var_req_builder = match "multi" {
            "multi" => local_var_req_builder.query(&local_var_str.into_iter().map(|p| ("virtual_circuit_id".to_owned(), p.to_string())).collect::<Vec<(std::string::String, std::string::String)>>()),
            _ => local_var_req_builder.query(&[("virtual_circuit_id", &local_var_str.into_iter().map(|p| p.to_string()).collect::<Vec<String>>().join(",").to_string())]),
        };
    }
    if let Some(ref local_var_user_agent) = local_var_configuration.user_agent {
        local_var_req_builder = local_var_req_builder.header(reqwest::header::USER_AGENT, local_var_user_agent.clone());
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<CircuitsCircuitGroupAssignmentsListError> = serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Err(Error::ResponseError(local_var_error))
    }
}
...
pub async fn circuits_circuit_group_assignments_partial_update(configuration: &configuration::Configuration, id: i32, patched_writable_circuit_group_assignment_request: Option<crate::models::PatchedWritableCircuitGroupAssignmentRequest>) -> Result<crate::models::CircuitGroupAssignment, Error<CircuitsCircuitGroupAssignmentsPartialUpdateError>> {
    let local_var_configuration = configuration;
    ...
    local_var_req_builder = local_var_req_builder.json(&patched_writable_circuit_group_assignment_request);
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<CircuitsCircuitGroupAssignmentsPartialUpdateError> = serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Err(Error::ResponseError(local_var_error))
    }
}
...
pub async fn circuits_circuit_group_assignments_retrieve(configuration: &configuration::Configuration, id: i32) -> Result<crate::models::CircuitGroupAssignment, Error<CircuitsCircuitGroupAssignmentsRetrieveError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<CircuitsCircuitGroupAssignmentsRetrieveError> = serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Err(Error::ResponseError(local_var_error))
    }
}
...
pub async fn circuits_circuit_group_assignments_update(configuration: &configuration::Configuration, id: i32, writable_circuit_group_assignment_request: crate::models::WritableCircuitGroupAssignmentRequest) -> Result<crate::models::CircuitGroupAssignment, Error<CircuitsCircuitGroupAssignmentsUpdateError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<CircuitsCircuitGroupAssignmentsUpdateError> = serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Err(Error::ResponseError(local_var_error))
    }
}
...
pub async fn circuits_circuit_groups_bulk_destroy(configuration: &configuration::Configuration, circuit_group_request: Vec<crate::models::CircuitGroupRequest>) -> Result<(), Error<CircuitsCircuitGroupsBulkDestroyError>> {
    let local_var_configuration = configuration;

    let local_var_client = &local_var_configuration.client;

    let local_var_uri_str = format!("{}/api/circuits/circuit-groups/", local_var_configuration.base_path);
    let mut local_var_req_builder = local_var_client.request(reqwest::Method::DELETE, local_var_uri_str.as_str());
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<CircuitsCircuitGroupsBulkDestroyError> = serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Err(Error::ResponseError(local_var_error))
    }
}
...
pub async fn circuits_circuit_groups_bulk_partial_update(configuration: &configuration::Configuration, circuit_group_request: Vec<crate::models::CircuitGroupRequest>) -> Result<Vec<crate::models::CircuitGroup>, Error<CircuitsCircuitGroupsBulkPartialUpdateError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<CircuitsCircuitGroupsBulkPartialUpdateError> = serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Err(Error::ResponseError(local_var_error))
    }
}
...
pub async fn circuits_circuit_groups_bulk_update(configuration: &configuration::Configuration, circuit_group_request: Vec<crate::models::CircuitGroupRequest>) -> Result<Vec<crate::models::CircuitGroup>, Error<CircuitsCircuitGroupsBulkUpdateError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<CircuitsCircuitGroupsBulkUpdateError> = serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Err(Error::ResponseError(local_var_error))
    }
}
...
pub async fn circuits_circuit_groups_create(configuration: &configuration::Configuration, circuit_group_request: crate::models::CircuitGroupRequest) -> Result<crate::models::CircuitGroup, Error<CircuitsCircuitGroupsCreateError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<CircuitsCircuitGroupsCreateError> = serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Err(Error::ResponseError(local_var_error))
    }
}
...
pub async fn circuits_circuit_groups_destroy(configuration: &configuration::Configuration, id: i32) -> Result<(), Error<CircuitsCircuitGroupsDestroyError>> {
    let local_var_configuration = configuration;

    let local_var_client = &local_var_configuration.client;

    let local_var_uri_str = format!("{}/api/circuits/circuit-groups/{id}/", local_var_configuration.base_path, id=id);
    let mut local_var_req_builder = local_var_client.request(reqwest::Method::DELETE, local_var_uri_str.as_str());
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<CircuitsCircuitGroupsDestroyError> = serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Err(Error::ResponseError(local_var_error))
    }
}
...
pub async fn circuits_circuit_groups_list(configuration: &configuration::Configuration, created: Option<Vec<String>>, created__empty: Option<Vec<String>>, created__gt: Option<Vec<String>>, created__gte: Option<Vec<String>>, created__lt: Option<Vec<String>>, created__lte: Option<Vec<String>>, created__n: Option<Vec<String>>, created_by_request: Option<&str>, description: Option<Vec<String>>, description__empty: Option<bool>, description__ic: Option<Vec<String>>, description__ie: Option<Vec<String>>, description__iew: Option<Vec<String>>, description__iregex: Option<Vec<String>>, description__isw: Option<Vec<String>>, description__n: Option<Vec<String>>, description__nic: Option<Vec<String>>, description__nie: Option<Vec<String>>, description__niew: Option<Vec<String>>, description__nisw: Option<Vec<String>>, description__regex: Option<Vec<String>>, id: Option<Vec<i32>>, id__empty: Option<bool>, id__gt: Option<Vec<i32>>, id__gte: Option<Vec<i32>>, id__lt: Option<Vec<i32>>, id__lte: Option<Vec<i32>>, id__n: Option<Vec<i32>>, last_updated: Option<Vec<String>>, last_updated__empty: Option<Vec<String>>, last_updated__gt: Option<Vec<String>>, last_updated__gte: Option<Vec<String>>, last_updated__lt: Option<Vec<String>>, last_updated__lte: Option<Vec<String>>, last_updated__n: Option<Vec<String>>, limit: Option<i32>, modified_by_request: Option<&str>, name: Option<Vec<String>>, name__empty: Option<bool>, name__ic: Option<Vec<String>>, name__ie: Option<Vec<String>>, name__iew: Option<Vec<String>>, name__iregex: Option<Vec<String>>, name__isw: Option<Vec<String>>, name__n: Option<Vec<String>>, name__nic: Option<Vec<String>>, name__nie: Option<Vec<String>>, name__niew: Option<Vec<String>>, name__nisw: Option<Vec<String>>, name__regex: Option<Vec<String>>, offset: Option<i32>, ordering: Option<&str>, q: Option<&str>, slug: Option<Vec<String>>, slug__empty: Option<bool>, slug__ic: Option<Vec<String>>, slug__ie: Option<Vec<String>>, slug__iew: Option<Vec<String>>, slug__iregex: Option<Vec<String>>, slug__isw: Option<Vec<String>>, slug__n: Option<Vec<String>>, slug__nic: Option<Vec<String>>, slug__nie: Option<Vec<String>>, slug__niew: Option<Vec<String>>, slug__nisw: Option<Vec<String>>, slug__regex: Option<Vec<String>>, tag: Option<Vec<String>>, tag__n: Option<Vec<String>>, tag_id: Option<Vec<i32>>, tag_id__n: Option<Vec<i32>>, tenant: Option<Vec<String>>, tenant__n: Option<Vec<String>>, tenant_group: Option<Vec<String>>, tenant_group__n: Option<Vec<String>>, tenant_group_id: Option<Vec<String>>, tenant_group_id__n: Option<Vec<String>>, tenant_id: Option<Vec<i32>>, tenant_id__n: Option<Vec<i32>>, updated_by_request: Option<&str>) -> Result<crate::models::PaginatedCircuitGroupList, Error<CircuitsCircuitGroupsListError>> {
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<CircuitsCircuitGroupsListError> = serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Err(Error::ResponseError(local_var_error))
    }
}
...
pub async fn circuits_circuit_groups_partial_update(configuration: &configuration::Configuration, id: i32, patched_circuit_group_request: Option<crate::models::PatchedCircuitGroupRequest>) -> Result<crate::models::CircuitGroup, Error<CircuitsCircuitGroupsPartialUpdateError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<CircuitsCircuitGroupsPartialUpdateError> = serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Err(Error::ResponseError(local_var_error))
    }
}
...
pub async fn circuits_circuit_groups_retrieve(configuration: &configuration::Configuration, id: i32) -> Result<crate::models::CircuitGroup, Error<CircuitsCircuitGroupsRetrieveError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<CircuitsCircuitGroupsRetrieveError> = serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Err(Error::ResponseError(local_var_error))
    }
}
...
pub async fn circuits_circuit_groups_update(configuration: &configuration::Configuration, id: i32, circuit_group_request: crate::models::CircuitGroupRequest) -> Result<crate::models::CircuitGroup, Error<CircuitsCircuitGroupsUpdateError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<CircuitsCircuitGroupsUpdateError> = serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Err(Error::ResponseError(local_var_error))
    }
}
...
pub async fn circuits_circuit_terminations_create(configuration: &configuration::Configuration, circuit_termination_request: crate::models::CircuitTerminationRequest) -> Result<crate::models::CircuitTermination, Error<CircuitsCircuitTerminationsCreateError>> {
    let local_var_configuration = configuration;
...
pub async fn circuits_circuit_terminations_list(configuration: &configuration::Configuration, cable_end: Option<&str>, cable_id: Option<Vec<i32>>, cable_id__n: Option<Vec<i32>>, cabled: Option<bool>, circuit_id: Option<Vec<i32>>, circuit_id__n: Option<Vec<i32>>, created: Option<Vec<String>>, created__empty: Option<Vec<String>>, created__gt: Option<Vec<String>>, created__gte: Option<Vec<String>>, created__lt: Option<Vec<String>>, created__lte: Option<Vec<String>>, created__n: Option<Vec<String>>, created_by_request: Option<&str>, description: Option<Vec<String>>, description__empty: Option<bool>, description__ic: Option<Vec<String>>, description__ie: Option<Vec<String>>, description__iew: Option<Vec<String>>, description__iregex: Option<Vec<String>>, description__isw: Option<Vec<String>>, description__n: Option<Vec<String>>, description__nic: Option<Vec<String>>, description__nie: Option<Vec<String>>, description__niew: Option<Vec<String>>, description__nisw: Option<Vec<String>>, description__regex: Option<Vec<String>>, id: Option<Vec<i32>>, id__empty: Option<bool>, id__gt: Option<Vec<i32>>, id__gte: Option<Vec<i32>>, id__lt: Option<Vec<i32>>, id__lte: Option<Vec<i32>>, id__n: Option<Vec<i32>>, last_updated: Option<Vec<String>>, last_updated__empty: Option<Vec<String>>, last_updated__gt: Option<Vec<String>>, last_updated__gte: Option<Vec<String>>, last_updated__lt: Option<Vec<String>>, last_updated__lte: Option<Vec<String>>, last_updated__n: Option<Vec<String>>, limit: Option<i32>, location: Option<Vec<String>>, location__n: Option<Vec<String>>, location_id: Option<Vec<String>>, location_id__n: Option<Vec<String>>, mark_connected: Option<bool>, modified_by_request: Option<&str>, occupied: Option<bool>, offset: Option<i32>, ordering: Option<&str>, port_speed: Option<Vec<i32>>, port_speed__empty: Option<bool>, port_speed__gt: Option<Vec<i32>>, port_speed__gte: Option<Vec<i32>>, port_speed__lt: Option<Vec<i32>>, port_speed__lte: Option<Vec<i32>>, port_speed__n: Option<Vec<i32>>, pp_info: Option<Vec<String>>, pp_info__empty: Option<bool>, pp_info__ic: Option<Vec<String>>, pp_info__ie: Option<Vec<String>>, pp_info__iew: Option<Vec<String>>, pp_info__iregex: Option<Vec<String>>, pp_info__isw: Option<Vec<String>>, pp_info__n: Option<Vec<String>>, pp_info__nic: Option<Vec<String>>, pp_info__nie: Option<Vec<String>>, pp_info__niew: Option<Vec<String>>, pp_info__nisw: Option<Vec<String>>, pp_info__regex: Option<Vec<String>>, provider: Option<Vec<String>>, provider__n: Option<Vec<String>>, provider_id: Option<Vec<i32>>, provider_id__n: Option<Vec<i32>>, provider_network_id: Option<Vec<i32>>, provider_network_id__n: Option<Vec<i32>>, q: Option<&str>, region: Option<Vec<String>>, region__n: Option<Vec<String>>, region_id: Option<Vec<String>>, region_id__n: Option<Vec<String>>, site: Option<Vec<String>>, site__n: Option<Vec<String>>, site_group: Option<Vec<String>>, site_group__n: Option<Vec<String>>, site_group_id: Option<Vec<String>>, site_group_id__n: Option<Vec<String>>, site_id: Option<Vec<i32>>, site_id__n: Option<Vec<i32>>, tag: Option<Vec<String>>, tag__n: Option<Vec<String>>, tag_id: Option<Vec<i32>>, tag_id__n: Option<Vec<i32>>, term_side: Option<&str>, termination_id: Option<Vec<i32>>, termination_id__empty: Option<bool>, termination_id__gt: Option<Vec<i32>>, termination_id__gte: Option<Vec<i32>>, termination_id__lt: Option<Vec<i32>>, termination_id__lte: Option<Vec<i32>>, termination_id__n: Option<Vec<i32>>, termination_type: Option<&str>, termination_type__n: Option<&str>, updated_by_request: Option<&str>, upstream_speed: Option<Vec<i32>>, upstream_speed__empty: Option<bool>, upstream_speed__gt: Option<Vec<i32>>, upstream_speed__gte: Option<Vec<i32>>, upstream_speed__lt: Option<Vec<i32>>, upstream_speed__lte: Option<Vec<i32>>, upstream_speed__n: Option<Vec<i32>>, xconnect_id: Option<Vec<String>>, xconnect_id__empty: Option<bool>, xconnect_id__ic: Option<Vec<String>>, xconnect_id__ie: Option<Vec<String>>, xconnect_id__iew: Option<Vec<String>>, xconnect_id__iregex: Option<Vec<String>>, xconnect_id__isw: Option<Vec<String>>, xconnect_id__n: Option<Vec<String>>, xconnect_id__nic: Option<Vec<String>>, xconnect_id__nie: Option<Vec<String>>, xconnect_id__niew: Option<Vec<String>>, xconnect_id__nisw: Option<Vec<String>>, xconnect_id__regex: Option<Vec<String>>) -> Result<crate::models::PaginatedCircuitTerminationList, Error<CircuitsCircuitTerminationsListError>> {
    let local_var_configuration = configuration;
    ...
    if let Some(ref local_var_str) = cable_id {
        local_var_req_builder = match "multi" {
            "multi" => local_var_req_builder.query(&local_var_str.into_iter().map(|p| ("cable_id".to_owned(), p.to_string())).collect::<Vec<(std::string::String, std::string::String)>>()),
            _ => local_var_req_builder.query(&[("cable_id", &local_var_str.into_iter().map(|p| p.to_string()).collect::<Vec<String>>().join(",").to_string())]),
        };
    }
    if let Some(ref local_var_str) = cable_id__n {
        local_var_req_builder = match "multi" {
            "multi" => local_var_req_builder.query(&local_var_str.into_iter().map(|p| ("cable_id__n".to_owned(), p.to_string())).collect::<Vec<(std::string::String, std::string::String)>>()),
            _ => local_var_req_builder.query(&[("cable_id__n", &local_var_str.into_iter().map(|p| p.to_string()).collect::<Vec<String>>().join(",").to_string())]),
        };
    }
    ...
    if let Some(ref local_var_str) = mark_connected {
        local_var_req_builder = local_var_req_builder.query(&[("mark_connected", &local_var_str.to_string())]);
    }
    if let Some(ref local_var_str) = modified_by_request {
        local_var_req_builder = local_var_req_builder.query(&[("modified_by_request", &local_var_str.to_string())]);
    }
    ...
    if let Some(ref local_var_str) = pp_info {
        local_var_req_builder = match "multi" {
            "multi" => local_var_req_builder.query(&local_var_str.into_iter().map(|p| ("pp_info".to_owned(), p.to_string())).collect::<Vec<(std::string::String, std::string::String)>>()),
            _ => local_var_req_builder.query(&[("pp_info", &local_var_str.into_iter().map(|p| p.to_string()).collect::<Vec<String>>().join(",").to_string())]),
        };
    }
    if let Some(ref local_var_str) = pp_info__empty {
        local_var_req_builder = local_var_req_builder.query(&[("pp_info__empty", &local_var_str.to_string())]);
    }
    if let Some(ref local_var_str) = pp_info__ic {
        local_var_req_builder = match "multi" {
            "multi" => local_var_req_builder.query(&local_var_str.into_iter().map(|p| ("pp_info__ic".to_owned(), p.to_string())).collect::<Vec<(std::string::String, std::string::String)>>()),
            _ => local_var_req_builder.query(&[("pp_info__ic", &local_var_str.into_iter().map(|p| p.to_string()).collect::<Vec<String>>().join(",").to_string())]),
        };
    }
    if let Some(ref local_var_str) = pp_info__ie {
        local_var_req_builder = match "multi" {
            "multi" => local_var_req_builder.query(&local_var_str.into_iter().map(|p| ("pp_info__ie".to_owned(), p.to_string())).collect::<Vec<(std::string::String, std::string::String)>>()),
            _ => local_var_req_builder.query(&[("pp_info__ie", &local_var_str.into_iter().map(|p| p.to_string()).collect::<Vec<String>>().join(",").to_string())]),
        };
    }
    if let Some(ref local_var_str) = pp_info__iew {
        local_var_req_builder = match "multi" {
            "multi" => local_var_req_builder.query(&local_var_str.into_iter().map(|p| ("pp_info__iew".to_owned(), p.to_string())).collect::<Vec<(std::string::String, std::string::String)>>()),
            _ => local_var_req_builder.query(&[("pp_info__iew", &local_var_str.into_iter().map(|p| p.to_string()).collect::<Vec<String>>().join(",").to_string())]),
        };
    }
    if let Some(ref local_var_str) = pp_info__iregex {
        local_var_req_builder = match "multi" {
            "multi" => local_var_req_builder.query(&local_var_str.into_iter().map(|p| ("pp_info__iregex".to_owned(), p.to_string())).collect::<Vec<(std::string::String, std::string::String)>>()),
            _ => local_var_req_builder.query(&[("pp_info__iregex", &local_var_str.into_iter().map(|p| p.to_string()).collect::<Vec<String>>().join(",").to_string())]),
        };
    }
    if let Some(ref local_var_str) = pp_info__isw {
        local_var_req_builder = match "multi" {
            "multi" => local_var_req_builder.query(&local_var_str.into_iter().map(|p| ("pp_info__isw".to_owned(), p.to_string())).collect::<Vec<(std::string::String, std::string::String)>>()),
            _ => local_var_req_builder.query(&[("pp_info__isw", &local_var_str.into_iter().map(|p| p.to_string()).collect::<Vec<String>>().join(",").to_string())]),
        };
    }
    if let Some(ref local_var_str) = pp_info__n {
        local_var_req_builder = match "multi" {
            "multi" => local_var_req_builder.query(&local_var_str.into_iter().map(|p| ("pp_info__n".to_owned(), p.to_string())).collect::<Vec<(std::string::String, std::string::String)>>()),
            _ => local_var_req_builder.query(&[("pp_info__n", &local_var_str.into_iter().map(|p| p.to_string()).collect::<Vec<String>>().join(",").to_string())]),
        };
    }
    if let Some(ref local_var_str) = pp_info__nic {
        local_var_req_builder = match "multi" {
            "multi" => local_var_req_builder.query(&local_var_str.into_iter().map(|p| ("pp_info__nic".to_owned(), p.to_string())).collect::<Vec<(std::string::String, std::string::String)>>()),
            _ => local_var_req_builder.query(&[("pp_info__nic", &local_var_str.into_iter().map(|p| p.to_string()).collect::<Vec<String>>().join(",").to_string())]),
        };
    }
    if let Some(ref local_var_str) = pp_info__nie {
        local_var_req_builder = match "multi" {
            "multi" => local_var_req_builder.query(&local_var_str.into_iter().map(|p| ("pp_info__nie".to_owned(), p.to_string())).collect::<Vec<(std::string::String, std::string::String)>>()),
            _ => local_var_req_builder.query(&[("pp_info__nie", &local_var_str.into_iter().map(|p| p.to_string()).collect::<Vec<String>>().join(",").to_string())]),
        };
    }
    if let Some(ref local_var_str) = pp_info__niew {
        local_var_req_builder = match "multi" {
            "multi" => local_var_req_builder.query(&local_var_str.into_iter().map(|p| ("pp_info__niew".to_owned(), p.to_string())).collect::<Vec<(std::string::String, std::string::String)>>()),
            _ => local_var_req_builder.query(&[("pp_info__niew", &local_var_str.into_iter().map(|p| p.to_string()).collect::<Vec<String>>().join(",").to_string())]),
        };
    }
    if let Some(ref local_var_str) = pp_info__nisw {
        local_var_req_builder = match "multi" {
            "multi" => local_var_req_builder.query(&local_var_str.into_iter().map(|p| ("pp_info__nisw".to_owned(), p.to_string())).collect::<Vec<(std::string::String, std::string::String)>>()),
            _ => local_var_req_builder.query(&[("pp_info__nisw", &local_var_str.into_iter().map(|p| p.to_string()).collect::<Vec<String>>().join(",").to_string())]),
        };
    }
    if let Some(ref local_var_str) = pp_info__regex {
        local_var_req_builder = match "multi" {
            "multi" => local_var_req_builder.query(&local_var_str.into_iter().map(|p| ("pp_info__regex".to_owned(), p.to_string())).collect::<Vec<(std::string::String, std::string::String)>>()),
            _ => local_var_req_builder.query(&[("pp_info__regex", &local_var_str.into_iter().map(|p| p.to_string()).collect::<Vec<String>>().join(",").to_string())]),
        };
    }
    if let Some(ref local_var_str) = provider {
        local_var_req_builder = match "multi" {
    ...
    if let Some(ref local_var_str) = xconnect_id__iregex {
        local_var_req_builder = match "multi" {
            "multi" => local_var_req_builder.query(&local_var_str.into_iter().map(|p| ("xconnect_id__iregex".to_owned(), p.to_string())).collect::<Vec<(std::string::String, std::string::String)>>()),
            _ => local_var_req_builder.query(&[("xconnect_id__iregex", &local_var_str.into_iter().map(|p| p.to_string()).collect::<Vec<String>>().join(",").to_string())]),
        };
    }
    ...
    if let Some(ref local_var_str) = xconnect_id__regex {
        local_var_req_builder = match "multi" {
            "multi" => local_var_req_builder.query(&local_var_str.into_iter().map(|p| ("xconnect_id__regex".to_owned(), p.to_string())).collect::<Vec<(std::string::String, std::string::String)>>()),
            _ => local_var_req_builder.query(&[("xconnect_id__regex", &local_var_str.into_iter().map(|p| p.to_string()).collect::<Vec<String>>().join(",").to_string())]),
        };
    }
    if let Some(ref local_var_user_agent) = local_var_configuration.user_agent {
        local_var_req_builder = local_var_req_builder.header(reqwest::header::USER_AGENT, local_var_user_agent.clone());
...
pub async fn circuits_circuit_terminations_partial_update(configuration: &configuration::Configuration, id: i32, patched_circuit_termination_request: Option<crate::models::PatchedCircuitTerminationRequest>) -> Result<crate::models::CircuitTermination, Error<CircuitsCircuitTerminationsPartialUpdateError>> {
    let local_var_configuration = configuration;
...
pub async fn circuits_circuit_terminations_update(configuration: &configuration::Configuration, id: i32, circuit_termination_request: crate::models::CircuitTerminationRequest) -> Result<crate::models::CircuitTermination, Error<CircuitsCircuitTerminationsUpdateError>> {
    let local_var_configuration = configuration;
...
pub async fn circuits_circuit_types_list(configuration: &configuration::Configuration, color: Option<Vec<String>>, color__empty: Option<bool>, color__ic: Option<Vec<String>>, color__ie: Option<Vec<String>>, color__iew: Option<Vec<String>>, color__iregex: Option<Vec<String>>, color__isw: Option<Vec<String>>, color__n: Option<Vec<String>>, color__nic: Option<Vec<String>>, color__nie: Option<Vec<String>>, color__niew: Option<Vec<String>>, color__nisw: Option<Vec<String>>, color__regex: Option<Vec<String>>, created: Option<Vec<String>>, created__empty: Option<Vec<String>>, created__gt: Option<Vec<String>>, created__gte: Option<Vec<String>>, created__lt: Option<Vec<String>>, created__lte: Option<Vec<String>>, created__n: Option<Vec<String>>, created_by_request: Option<&str>, description: Option<Vec<String>>, description__empty: Option<bool>, description__ic: Option<Vec<String>>, description__ie: Option<Vec<String>>, description__iew: Option<Vec<String>>, description__iregex: Option<Vec<String>>, description__isw: Option<Vec<String>>, description__n: Option<Vec<String>>, description__nic: Option<Vec<String>>, description__nie: Option<Vec<String>>, description__niew: Option<Vec<String>>, description__nisw: Option<Vec<String>>, description__regex: Option<Vec<String>>, id: Option<Vec<i32>>, id__empty: Option<bool>, id__gt: Option<Vec<i32>>, id__gte: Option<Vec<i32>>, id__lt: Option<Vec<i32>>, id__lte: Option<Vec<i32>>, id__n: Option<Vec<i32>>, last_updated: Option<Vec<String>>, last_updated__empty: Option<Vec<String>>, last_updated__gt: Option<Vec<String>>, last_updated__gte: Option<Vec<String>>, last_updated__lt: Option<Vec<String>>, last_updated__lte: Option<Vec<String>>, last_updated__n: Option<Vec<String>>, limit: Option<i32>, modified_by_request: Option<&str>, name: Option<Vec<String>>, name__empty: Option<bool>, name__ic: Option<Vec<String>>, name__ie: Option<Vec<String>>, name__iew: Option<Vec<String>>, name__iregex: Option<Vec<String>>, name__isw: Option<Vec<String>>, name__n: Option<Vec<String>>, name__nic: Option<Vec<String>>, name__nie: Option<Vec<String>>, name__niew: Option<Vec<String>>, name__nisw: Option<Vec<String>>, name__regex: Option<Vec<String>>, offset: Option<i32>, ordering: Option<&str>, q: Option<&str>, slug: Option<Vec<String>>, slug__empty: Option<bool>, slug__ic: Option<Vec<String>>, slug__ie: Option<Vec<String>>, slug__iew: Option<Vec<String>>, slug__iregex: Option<Vec<String>>, slug__isw: Option<Vec<String>>, slug__n: Option<Vec<String>>, slug__nic: Option<Vec<String>>, slug__nie: Option<Vec<String>>, slug__niew: Option<Vec<String>>, slug__nisw: Option<Vec<String>>, slug__regex: Option<Vec<String>>, tag: Option<Vec<String>>, tag__n: Option<Vec<String>>, tag_id: Option<Vec<i32>>, tag_id__n: Option<Vec<i32>>, updated_by_request: Option<&str>) -> Result<crate::models::PaginatedCircuitTypeList, Error<CircuitsCircuitTypesListError>> {
    let local_var_configuration = configuration;
    ...
    if let Some(ref local_var_str) = color__iregex {
        local_var_req_builder = match "multi" {
            "multi" => local_var_req_builder.query(&local_var_str.into_iter().map(|p| ("color__iregex".to_owned(), p.to_string())).collect::<Vec<(std::string::String, std::string::String)>>()),
            _ => local_var_req_builder.query(&[("color__iregex", &local_var_str.into_iter().map(|p| p.to_string()).collect::<Vec<String>>().join(",").to_string())]),
        };
    }
    ...
    if let Some(ref local_var_str) = color__regex {
        local_var_req_builder = match "multi" {
            "multi" => local_var_req_builder.query(&local_var_str.into_iter().map(|p| ("color__regex".to_owned(), p.to_string())).collect::<Vec<(std::string::String, std::string::String)>>()),
            _ => local_var_req_builder.query(&[("color__regex", &local_var_str.into_iter().map(|p| p.to_string()).collect::<Vec<String>>().join(",").to_string())]),
        };
    }
    if let Some(ref local_var_str) = created {
        local_var_req_builder = match "multi" {
...
pub async fn circuits_circuits_list(configuration: &configuration::Configuration, cid: Option<Vec<String>>, cid__empty: Option<bool>, cid__ic: Option<Vec<String>>, cid__ie: Option<Vec<String>>, cid__iew: Option<Vec<String>>, cid__iregex: Option<Vec<String>>, cid__isw: Option<Vec<String>>, cid__n: Option<Vec<String>>, cid__nic: Option<Vec<String>>, cid__nie: Option<Vec<String>>, cid__niew: Option<Vec<String>>, cid__nisw: Option<Vec<String>>, cid__regex: Option<Vec<String>>, commit_rate: Option<Vec<i32>>, commit_rate__empty: Option<bool>, commit_rate__gt: Option<Vec<i32>>, commit_rate__gte: Option<Vec<i32>>, commit_rate__lt: Option<Vec<i32>>, commit_rate__lte: Option<Vec<i32>>, commit_rate__n: Option<Vec<i32>>, contact: Option<Vec<i32>>, contact__n: Option<Vec<i32>>, contact_group: Option<Vec<String>>, contact_group__n: Option<Vec<String>>, contact_role: Option<Vec<i32>>, contact_role__n: Option<Vec<i32>>, created: Option<Vec<String>>, created__empty: Option<Vec<String>>, created__gt: Option<Vec<String>>, created__gte: Option<Vec<String>>, created__lt: Option<Vec<String>>, created__lte: Option<Vec<String>>, created__n: Option<Vec<String>>, created_by_request: Option<&str>, description: Option<Vec<String>>, description__empty: Option<bool>, description__ic: Option<Vec<String>>, description__ie: Option<Vec<String>>, description__iew: Option<Vec<String>>, description__iregex: Option<Vec<String>>, description__isw: Option<Vec<String>>, description__n: Option<Vec<String>>, description__nic: Option<Vec<String>>, description__nie: Option<Vec<String>>, description__niew: Option<Vec<String>>, description__nisw: Option<Vec<String>>, description__regex: Option<Vec<String>>, distance: Option<Vec<f64>>, distance__empty: Option<bool>, distance__gt: Option<Vec<f64>>, distance__gte: Option<Vec<f64>>, distance__lt: Option<Vec<f64>>, distance__lte: Option<Vec<f64>>, distance__n: Option<Vec<f64>>, distance_unit: Option<&str>, id: Option<Vec<i32>>, id__empty: Option<bool>, id__gt: Option<Vec<i32>>, id__gte: Option<Vec<i32>>, id__lt: Option<Vec<i32>>, id__lte: Option<Vec<i32>>, id__n: Option<Vec<i32>>, install_date: Option<Vec<String>>, install_date__empty: Option<bool>, install_date__gt: Option<Vec<String>>, install_date__gte: Option<Vec<String>>, install_date__lt: Option<Vec<String>>, install_date__lte: Option<Vec<String>>, install_date__n: Option<Vec<String>>, last_updated: Option<Vec<String>>, last_updated__empty: Option<Vec<String>>, last_updated__gt: Option<Vec<String>>, last_updated__gte: Option<Vec<String>>, last_updated__lt: Option<Vec<String>>, last_updated__lte: Option<Vec<String>>, last_updated__n: Option<Vec<String>>, limit: Option<i32>, location_id: Option<Vec<i32>>, location_id__n: Option<Vec<i32>>, modified_by_request: Option<&str>, offset: Option<i32>, ordering: Option<&str>, provider: Option<Vec<String>>, provider__n: Option<Vec<String>>, provider_account: Option<Vec<String>>, provider_account__n: Option<Vec<String>>, provider_account_id: Option<Vec<i32>>, provider_account_id__n: Option<Vec<i32>>, provider_id: Option<Vec<i32>>, provider_id__n: Option<Vec<i32>>, provider_network_id: Option<Vec<i32>>, provider_network_id__n: Option<Vec<i32>>, q: Option<&str>, region: Option<Vec<String>>, region__n: Option<Vec<String>>, region_id: Option<Vec<String>>, region_id__n: Option<Vec<String>>, site: Option<Vec<String>>, site__n: Option<Vec<String>>, site_group: Option<Vec<String>>, site_group__n: Option<Vec<String>>, site_group_id: Option<Vec<String>>, site_group_id__n: Option<Vec<String>>, site_id: Option<Vec<i32>>, site_id__n: Option<Vec<i32>>, status: Option<Vec<String>>, status__empty: Option<bool>, status__ic: Option<Vec<String>>, status__ie: Option<Vec<String>>, status__iew: Option<Vec<String>>, status__iregex: Option<Vec<String>>, status__isw: Option<Vec<String>>, status__n: Option<Vec<String>>, status__nic: Option<Vec<String>>, status__nie: Option<Vec<String>>, status__niew: Option<Vec<String>>, status__nisw: Option<Vec<String>>, status__regex: Option<Vec<String>>, tag: Option<Vec<String>>, tag__n: Option<Vec<String>>, tag_id: Option<Vec<i32>>, tag_id__n: Option<Vec<i32>>, tenant: Option<Vec<String>>, tenant__n: Option<Vec<String>>, tenant_group: Option<Vec<String>>, tenant_group__n: Option<Vec<String>>, tenant_group_id: Option<Vec<String>>, tenant_group_id__n: Option<Vec<String>>, tenant_id: Option<Vec<i32>>, tenant_id__n: Option<Vec<i32>>, termination_a_id: Option<Vec<i32>>, termination_a_id__n: Option<Vec<i32>>, termination_date: Option<Vec<String>>, termination_date__empty: Option<bool>, termination_date__gt: Option<Vec<String>>, termination_date__gte: Option<Vec<String>>, termination_date__lt: Option<Vec<String>>, termination_date__lte: Option<Vec<String>>, termination_date__n: Option<Vec<String>>, termination_z_id: Option<Vec<i32>>, termination_z_id__n: Option<Vec<i32>>, r#type: Option<Vec<String>>, type__n: Option<Vec<String>>, type_id: Option<Vec<i32>>, type_id__n: Option<Vec<i32>>, updated_by_request: Option<&str>) -> Result<crate::models::PaginatedCircuitList, Error<CircuitsCircuitsListError>> {
    let local_var_configuration = configuration;
    ...
    if let Some(ref local_var_str) = cid__iregex {
        local_var_req_builder = match "multi" {
            "multi" => local_var_req_builder.query(&local_var_str.into_iter().map(|p| ("cid__iregex".to_owned(), p.to_string())).collect::<Vec<(std::string::String, std::string::String)>>()),
            _ => local_var_req_builder.query(&[("cid__iregex", &local_var_str.into_iter().map(|p| p.to_string()).collect::<Vec<String>>().join(",").to_string())]),
        };
    }
    ...
    if let Some(ref local_var_str) = cid__regex {
        local_var_req_builder = match "multi" {
            "multi" => local_var_req_builder.query(&local_var_str.into_iter().map(|p| ("cid__regex".to_owned(), p.to_string())).collect::<Vec<(std::string::String, std::string::String)>>()),
            _ => local_var_req_builder.query(&[("cid__regex", &local_var_str.into_iter().map(|p| p.to_string()).collect::<Vec<String>>().join(",").to_string())]),
        };
    }
    ...
    if let Some(ref local_var_str) = provider_account {
        local_var_req_builder = match "multi" {
            "multi" => local_var_req_builder.query(&local_var_str.into_iter().map(|p| ("provider_account".to_owned(), p.to_string())).collect::<Vec<(std::string::String, std::string::String)>>()),
            _ => local_var_req_builder.query(&[("provider_account", &local_var_str.into_iter().map(|p| p.to_string()).collect::<Vec<String>>().join(",").to_string())]),
        };
    }
    if let Some(ref local_var_str) = provider_account__n {
        local_var_req_builder = match "multi" {
            "multi" => local_var_req_builder.query(&local_var_str.into_iter().map(|p| ("provider_account__n".to_owned(), p.to_string())).collect::<Vec<(std::string::String, std::string::String)>>()),
            _ => local_var_req_builder.query(&[("provider_account__n", &local_var_str.into_iter().map(|p| p.to_string()).collect::<Vec<String>>().join(",").to_string())]),
        };
    }
    ...
    if let Some(ref local_var_str) = termination_a_id__n {
        local_var_req_builder = match "multi" {
            "multi" => local_var_req_builder.query(&local_var_str.into_iter().map(|p| ("termination_a_id__n".to_owned(), p.to_string())).collect::<Vec<(std::string::String, std::string::String)>>()),
            _ => local_var_req_builder.query(&[("termination_a_id__n", &local_var_str.into_iter().map(|p| p.to_string()).collect::<Vec<String>>().join(",").to_string())]),
        };
    }
    ...
    if let Some(ref local_var_str) = termination_z_id {
        local_var_req_builder = match "multi" {
            "multi" => local_var_req_builder.query(&local_var_str.into_iter().map(|p| ("termination_z_id".to_owned(), p.to_string())).collect::<Vec<(std::string::String, std::string::String)>>()),
            _ => local_var_req_builder.query(&[("termination_z_id", &local_var_str.into_iter().map(|p| p.to_string()).collect::<Vec<String>>().join(",").to_string())]),
        };
    }
    if let Some(ref local_var_str) = termination_z_id__n {
        local_var_req_builder = match "multi" {
            "multi" => local_var_req_builder.query(&local_var_str.into_iter().map(|p| ("termination_z_id__n".to_owned(), p.to_string())).collect::<Vec<(std::string::String, std::string::String)>>()),
            _ => local_var_req_builder.query(&[("termination_z_id__n", &local_var_str.into_iter().map(|p| p.to_string()).collect::<Vec<String>>().join(",").to_string())]),
        };
    }
...
pub async fn circuits_provider_accounts_create(configuration: &configuration::Configuration, provider_account_request: crate::models::ProviderAccountRequest) -> Result<crate::models::ProviderAccount, Error<CircuitsProviderAccountsCreateError>> {
    let local_var_configuration = configuration;
...
pub async fn circuits_provider_accounts_list(configuration: &configuration::Configuration, account: Option<Vec<String>>, account__empty: Option<bool>, account__ic: Option<Vec<String>>, account__ie: Option<Vec<String>>, account__iew: Option<Vec<String>>, account__iregex: Option<Vec<String>>, account__isw: Option<Vec<String>>, account__n: Option<Vec<String>>, account__nic: Option<Vec<String>>, account__nie: Option<Vec<String>>, account__niew: Option<Vec<String>>, account__nisw: Option<Vec<String>>, account__regex: Option<Vec<String>>, contact: Option<Vec<i32>>, contact__n: Option<Vec<i32>>, contact_group: Option<Vec<String>>, contact_group__n: Option<Vec<String>>, contact_role: Option<Vec<i32>>, contact_role__n: Option<Vec<i32>>, created: Option<Vec<String>>, created__empty: Option<Vec<String>>, created__gt: Option<Vec<String>>, created__gte: Option<Vec<String>>, created__lt: Option<Vec<String>>, created__lte: Option<Vec<String>>, created__n: Option<Vec<String>>, created_by_request: Option<&str>, description: Option<Vec<String>>, description__empty: Option<bool>, description__ic: Option<Vec<String>>, description__ie: Option<Vec<String>>, description__iew: Option<Vec<String>>, description__iregex: Option<Vec<String>>, description__isw: Option<Vec<String>>, description__n: Option<Vec<String>>, description__nic: Option<Vec<String>>, description__nie: Option<Vec<String>>, description__niew: Option<Vec<String>>, description__nisw: Option<Vec<String>>, description__regex: Option<Vec<String>>, id: Option<Vec<i32>>, id__empty: Option<bool>, id__gt: Option<Vec<i32>>, id__gte: Option<Vec<i32>>, id__lt: Option<Vec<i32>>, id__lte: Option<Vec<i32>>, id__n: Option<Vec<i32>>, last_updated: Option<Vec<String>>, last_updated__empty: Option<Vec<String>>, last_updated__gt: Option<Vec<String>>, last_updated__gte: Option<Vec<String>>, last_updated__lt: Option<Vec<String>>, last_updated__lte: Option<Vec<String>>, last_updated__n: Option<Vec<String>>, limit: Option<i32>, modified_by_request: Option<&str>, name: Option<Vec<String>>, name__empty: Option<bool>, name__ic: Option<Vec<String>>, name__ie: Option<Vec<String>>, name__iew: Option<Vec<String>>, name__iregex: Option<Vec<String>>, name__isw: Option<Vec<String>>, name__n: Option<Vec<String>>, name__nic: Option<Vec<String>>, name__nie: Option<Vec<String>>, name__niew: Option<Vec<String>>, name__nisw: Option<Vec<String>>, name__regex: Option<Vec<String>>, offset: Option<i32>, ordering: Option<&str>, provider: Option<Vec<String>>, provider__n: Option<Vec<String>>, provider_id: Option<Vec<i32>>, provider_id__n: Option<Vec<i32>>, q: Option<&str>, tag: Option<Vec<String>>, tag__n: Option<Vec<String>>, tag_id: Option<Vec<i32>>, tag_id__n: Option<Vec<i32>>, updated_by_request: Option<&str>) -> Result<crate::models::PaginatedProviderAccountList, Error<CircuitsProviderAccountsListError>> {
    let local_var_configuration = configuration;
    ...
    if let Some(ref local_var_str) = account__iregex {
        local_var_req_builder = match "multi" {
            "multi" => local_var_req_builder.query(&local_var_str.into_iter().map(|p| ("account__iregex".to_owned(), p.to_string())).collect::<Vec<(std::string::String, std::string::String)>>()),
            _ => local_var_req_builder.query(&[("account__iregex", &local_var_str.into_iter().map(|p| p.to_string()).collect::<Vec<String>>().join(",").to_string())]),
        };
    }
    ...
    if let Some(ref local_var_str) = account__regex {
        local_var_req_builder = match "multi" {
            "multi" => local_var_req_builder.query(&local_var_str.into_iter().map(|p| ("account__regex".to_owned(), p.to_string())).collect::<Vec<(std::string::String, std::string::String)>>()),
            _ => local_var_req_builder.query(&[("account__regex", &local_var_str.into_iter().map(|p| p.to_string()).collect::<Vec<String>>().join(",").to_string())]),
        };
    }
    if let Some(ref local_var_str) = contact {
        local_var_req_builder = match "multi" {
...
pub async fn circuits_provider_accounts_partial_update(configuration: &configuration::Configuration, id: i32, patched_provider_account_request: Option<crate::models::PatchedProviderAccountRequest>) -> Result<crate::models::ProviderAccount, Error<CircuitsProviderAccountsPartialUpdateError>> {
    let local_var_configuration = configuration;
...
pub async fn circuits_provider_accounts_update(configuration: &configuration::Configuration, id: i32, provider_account_request: crate::models::ProviderAccountRequest) -> Result<crate::models::ProviderAccount, Error<CircuitsProviderAccountsUpdateError>> {
    let local_var_configuration = configuration;
...
pub async fn circuits_provider_networks_create(configuration: &configuration::Configuration, provider_network_request: crate::models::ProviderNetworkRequest) -> Result<crate::models::ProviderNetwork, Error<CircuitsProviderNetworksCreateError>> {
    let local_var_configuration = configuration;
...
pub async fn circuits_provider_networks_list(configuration: &configuration::Configuration, created: Option<Vec<String>>, created__empty: Option<Vec<String>>, created__gt: Option<Vec<String>>, created__gte: Option<Vec<String>>, created__lt: Option<Vec<String>>, created__lte: Option<Vec<String>>, created__n: Option<Vec<String>>, created_by_request: Option<&str>, description: Option<Vec<String>>, description__empty: Option<bool>, description__ic: Option<Vec<String>>, description__ie: Option<Vec<String>>, description__iew: Option<Vec<String>>, description__iregex: Option<Vec<String>>, description__isw: Option<Vec<String>>, description__n: Option<Vec<String>>, description__nic: Option<Vec<String>>, description__nie: Option<Vec<String>>, description__niew: Option<Vec<String>>, description__nisw: Option<Vec<String>>, description__regex: Option<Vec<String>>, id: Option<Vec<i32>>, id__empty: Option<bool>, id__gt: Option<Vec<i32>>, id__gte: Option<Vec<i32>>, id__lt: Option<Vec<i32>>, id__lte: Option<Vec<i32>>, id__n: Option<Vec<i32>>, last_updated: Option<Vec<String>>, last_updated__empty: Option<Vec<String>>, last_updated__gt: Option<Vec<String>>, last_updated__gte: Option<Vec<String>>, last_updated__lt: Option<Vec<String>>, last_updated__lte: Option<Vec<String>>, last_updated__n: Option<Vec<String>>, limit: Option<i32>, modified_by_request: Option<&str>, name: Option<Vec<String>>, name__empty: Option<bool>, name__ic: Option<Vec<String>>, name__ie: Option<Vec<String>>, name__iew: Option<Vec<String>>, name__iregex: Option<Vec<String>>, name__isw: Option<Vec<String>>, name__n: Option<Vec<String>>, name__nic: Option<Vec<String>>, name__nie: Option<Vec<String>>, name__niew: Option<Vec<String>>, name__nisw: Option<Vec<String>>, name__regex: Option<Vec<String>>, offset: Option<i32>, ordering: Option<&str>, provider: Option<Vec<String>>, provider__n: Option<Vec<String>>, provider_id: Option<Vec<i32>>, provider_id__n: Option<Vec<i32>>, q: Option<&str>, service_id: Option<Vec<String>>, service_id__empty: Option<bool>, service_id__ic: Option<Vec<String>>, service_id__ie: Option<Vec<String>>, service_id__iew: Option<Vec<String>>, service_id__iregex: Option<Vec<String>>, service_id__isw: Option<Vec<String>>, service_id__n: Option<Vec<String>>, service_id__nic: Option<Vec<String>>, service_id__nie: Option<Vec<String>>, service_id__niew: Option<Vec<String>>, service_id__nisw: Option<Vec<String>>, service_id__regex: Option<Vec<String>>, tag: Option<Vec<String>>, tag__n: Option<Vec<String>>, tag_id: Option<Vec<i32>>, tag_id__n: Option<Vec<i32>>, updated_by_request: Option<&str>) -> Result<crate::models::PaginatedProviderNetworkList, Error<CircuitsProviderNetworksListError>> {
    let local_var_configuration = configuration;
    ...
    if let Some(ref local_var_str) = service_id__iregex {
        local_var_req_builder = match "multi" {
            "multi" => local_var_req_builder.query(&local_var_str.into_iter().map(|p| ("service_id__iregex".to_owned(), p.to_string())).collect::<Vec<(std::string::String, std::string::String)>>()),
            _ => local_var_req_builder.query(&[("service_id__iregex", &local_var_str.into_iter().map(|p| p.to_string()).collect::<Vec<String>>().join(",").to_string())]),
        };
    }
    ...
    if let Some(ref local_var_str) = service_id__regex {
        local_var_req_builder = match "multi" {
            "multi" => local_var_req_builder.query(&local_var_str.into_iter().map(|p| ("service_id__regex".to_owned(), p.to_string())).collect::<Vec<(std::string::String, std::string::String)>>()),
            _ => local_var_req_builder.query(&[("service_id__regex", &local_var_str.into_iter().map(|p| p.to_string()).collect::<Vec<String>>().join(",").to_string())]),
        };
    }
    if let Some(ref local_var_str) = tag {
        local_var_req_builder = match "multi" {
...
pub async fn circuits_provider_networks_partial_update(configuration: &configuration::Configuration, id: i32, patched_provider_network_request: Option<crate::models::PatchedProviderNetworkRequest>) -> Result<crate::models::ProviderNetwork, Error<CircuitsProviderNetworksPartialUpdateError>> {
    let local_var_configuration = configuration;
...
pub async fn circuits_provider_networks_update(configuration: &configuration::Configuration, id: i32, provider_network_request: crate::models::ProviderNetworkRequest) -> Result<crate::models::ProviderNetwork, Error<CircuitsProviderNetworksUpdateError>> {
    let local_var_configuration = configuration;
...
pub async fn circuits_providers_create(configuration: &configuration::Configuration, provider_request: crate::models::ProviderRequest) -> Result<crate::models::Provider, Error<CircuitsProvidersCreateError>> {
    let local_var_configuration = configuration;
...
pub async fn circuits_providers_list(configuration: &configuration::Configuration, asn: Option<Vec<i64>>, asn__n: Option<Vec<i64>>, asn_id: Option<Vec<i32>>, asn_id__n: Option<Vec<i32>>, contact: Option<Vec<i32>>, contact__n: Option<Vec<i32>>, contact_group: Option<Vec<String>>, contact_group__n: Option<Vec<String>>, contact_role: Option<Vec<i32>>, contact_role__n: Option<Vec<i32>>, created: Option<Vec<String>>, created__empty: Option<Vec<String>>, created__gt: Option<Vec<String>>, created__gte: Option<Vec<String>>, created__lt: Option<Vec<String>>, created__lte: Option<Vec<String>>, created__n: Option<Vec<String>>, created_by_request: Option<&str>, description: Option<Vec<String>>, description__empty: Option<bool>, description__ic: Option<Vec<String>>, description__ie: Option<Vec<String>>, description__iew: Option<Vec<String>>, description__iregex: Option<Vec<String>>, description__isw: Option<Vec<String>>, description__n: Option<Vec<String>>, description__nic: Option<Vec<String>>, description__nie: Option<Vec<String>>, description__niew: Option<Vec<String>>, description__nisw: Option<Vec<String>>, description__regex: Option<Vec<String>>, id: Option<Vec<i32>>, id__empty: Option<bool>, id__gt: Option<Vec<i32>>, id__gte: Option<Vec<i32>>, id__lt: Option<Vec<i32>>, id__lte: Option<Vec<i32>>, id__n: Option<Vec<i32>>, last_updated: Option<Vec<String>>, last_updated__empty: Option<Vec<String>>, last_updated__gt: Option<Vec<String>>, last_updated__gte: Option<Vec<String>>, last_updated__lt: Option<Vec<String>>, last_updated__lte: Option<Vec<String>>, last_updated__n: Option<Vec<String>>, limit: Option<i32>, modified_by_request: Option<&str>, name: Option<Vec<String>>, name__empty: Option<bool>, name__ic: Option<Vec<String>>, name__ie: Option<Vec<String>>, name__iew: Option<Vec<String>>, name__iregex: Option<Vec<String>>, name__isw: Option<Vec<String>>, name__n: Option<Vec<String>>, name__nic: Option<Vec<String>>, name__nie: Option<Vec<String>>, name__niew: Option<Vec<String>>, name__nisw: Option<Vec<String>>, name__regex: Option<Vec<String>>, offset: Option<i32>, ordering: Option<&str>, q: Option<&str>, region: Option<Vec<String>>, region__n: Option<Vec<String>>, region_id: Option<Vec<String>>, region_id__n: Option<Vec<String>>, site: Option<Vec<String>>, site__n: Option<Vec<String>>, site_group: Option<Vec<String>>, site_group__n: Option<Vec<String>>, site_group_id: Option<Vec<String>>, site_group_id__n: Option<Vec<String>>, site_id: Option<Vec<i32>>, site_id__n: Option<Vec<i32>>, slug: Option<Vec<String>>, slug__empty: Option<bool>, slug__ic: Option<Vec<String>>, slug__ie: Option<Vec<String>>, slug__iew: Option<Vec<String>>, slug__iregex: Option<Vec<String>>, slug__isw: Option<Vec<String>>, slug__n: Option<Vec<String>>, slug__nic: Option<Vec<String>>, slug__nie: Option<Vec<String>>, slug__niew: Option<Vec<String>>, slug__nisw: Option<Vec<String>>, slug__regex: Option<Vec<String>>, tag: Option<Vec<String>>, tag__n: Option<Vec<String>>, tag_id: Option<Vec<i32>>, tag_id__n: Option<Vec<i32>>, updated_by_request: Option<&str>) -> Result<crate::models::PaginatedProviderList, Error<CircuitsProvidersListError>> {
    let local_var_configuration = configuration;
...
pub async fn circuits_providers_partial_update(configuration: &configuration::Configuration, id: i32, patched_provider_request: Option<crate::models::PatchedProviderRequest>) -> Result<crate::models::Provider, Error<CircuitsProvidersPartialUpdateError>> {
    let local_var_configuration = configuration;
...
pub async fn circuits_providers_update(configuration: &configuration::Configuration, id: i32, provider_request: crate::models::ProviderRequest) -> Result<crate::models::Provider, Error<CircuitsProvidersUpdateError>> {
    let local_var_configuration = configuration;
...
pub async fn circuits_virtual_circuit_terminations_bulk_destroy(configuration: &configuration::Configuration, virtual_circuit_termination_request: Vec<crate::models::VirtualCircuitTerminationRequest>) -> Result<(), Error<CircuitsVirtualCircuitTerminationsBulkDestroyError>> {
    let local_var_configuration = configuration;

    let local_var_client = &local_var_configuration.client;

    let local_var_uri_str = format!("{}/api/circuits/virtual-circuit-terminations/", local_var_configuration.base_path);
    let mut local_var_req_builder = local_var_client.request(reqwest::Method::DELETE, local_var_uri_str.as_str());
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<CircuitsVirtualCircuitTerminationsBulkDestroyError> = serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Err(Error::ResponseError(local_var_error))
    }
}
...
pub async fn circuits_virtual_circuit_terminations_bulk_partial_update(configuration: &configuration::Configuration, virtual_circuit_termination_request: Vec<crate::models::VirtualCircuitTerminationRequest>) -> Result<Vec<crate::models::VirtualCircuitTermination>, Error<CircuitsVirtualCircuitTerminationsBulkPartialUpdateError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<CircuitsVirtualCircuitTerminationsBulkPartialUpdateError> = serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Err(Error::ResponseError(local_var_error))
    }
}
...
pub async fn circuits_virtual_circuit_terminations_bulk_update(configuration: &configuration::Configuration, virtual_circuit_termination_request: Vec<crate::models::VirtualCircuitTerminationRequest>) -> Result<Vec<crate::models::VirtualCircuitTermination>, Error<CircuitsVirtualCircuitTerminationsBulkUpdateError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<CircuitsVirtualCircuitTerminationsBulkUpdateError> = serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Err(Error::ResponseError(local_var_error))
    }
}
...
pub async fn circuits_virtual_circuit_terminations_create(configuration: &configuration::Configuration, writable_virtual_circuit_termination_request: crate::models::WritableVirtualCircuitTerminationRequest) -> Result<crate::models::VirtualCircuitTermination, Error<CircuitsVirtualCircuitTerminationsCreateError>> {
    let local_var_configuration = configuration;
    ...
    local_var_req_builder = local_var_req_builder.json(&writable_virtual_circuit_termination_request);
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<CircuitsVirtualCircuitTerminationsCreateError> = serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Err(Error::ResponseError(local_var_error))
    }
}
...
pub async fn circuits_virtual_circuit_terminations_destroy(configuration: &configuration::Configuration, id: i32) -> Result<(), Error<CircuitsVirtualCircuitTerminationsDestroyError>> {
    let local_var_configuration = configuration;

    let local_var_client = &local_var_configuration.client;

    let local_var_uri_str = format!("{}/api/circuits/virtual-circuit-terminations/{id}/", local_var_configuration.base_path, id=id);
    let mut local_var_req_builder = local_var_client.request(reqwest::Method::DELETE, local_var_uri_str.as_str());
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<CircuitsVirtualCircuitTerminationsDestroyError> = serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Err(Error::ResponseError(local_var_error))
    }
}
...
pub async fn circuits_virtual_circuit_terminations_list(configuration: &configuration::Configuration, created: Option<Vec<String>>, created__empty: Option<Vec<String>>, created__gt: Option<Vec<String>>, created__gte: Option<Vec<String>>, created__lt: Option<Vec<String>>, created__lte: Option<Vec<String>>, created__n: Option<Vec<String>>, created_by_request: Option<&str>, description: Option<Vec<String>>, description__empty: Option<bool>, description__ic: Option<Vec<String>>, description__ie: Option<Vec<String>>, description__iew: Option<Vec<String>>, description__iregex: Option<Vec<String>>, description__isw: Option<Vec<String>>, description__n: Option<Vec<String>>, description__nic: Option<Vec<String>>, description__nie: Option<Vec<String>>, description__niew: Option<Vec<String>>, description__nisw: Option<Vec<String>>, description__regex: Option<Vec<String>>, id: Option<Vec<i32>>, id__empty: Option<bool>, id__gt: Option<Vec<i32>>, id__gte: Option<Vec<i32>>, id__lt: Option<Vec<i32>>, id__lte: Option<Vec<i32>>, id__n: Option<Vec<i32>>, interface_id: Option<Vec<i32>>, interface_id__n: Option<Vec<i32>>, last_updated: Option<Vec<String>>, last_updated__empty: Option<Vec<String>>, last_updated__gt: Option<Vec<String>>, last_updated__gte: Option<Vec<String>>, last_updated__lt: Option<Vec<String>>, last_updated__lte: Option<Vec<String>>, last_updated__n: Option<Vec<String>>, limit: Option<i32>, modified_by_request: Option<&str>, offset: Option<i32>, ordering: Option<&str>, provider: Option<Vec<String>>, provider__n: Option<Vec<String>>, provider_account: Option<Vec<String>>, provider_account__n: Option<Vec<String>>, provider_account_id: Option<Vec<i32>>, provider_account_id__n: Option<Vec<i32>>, provider_id: Option<Vec<i32>>, provider_id__n: Option<Vec<i32>>, provider_network_id: Option<Vec<i32>>, provider_network_id__n: Option<Vec<i32>>, q: Option<&str>, role: Option<Vec<String>>, role__empty: Option<bool>, role__ic: Option<Vec<String>>, role__ie: Option<Vec<String>>, role__iew: Option<Vec<String>>, role__iregex: Option<Vec<String>>, role__isw: Option<Vec<String>>, role__n: Option<Vec<String>>, role__nic: Option<Vec<String>>, role__nie: Option<Vec<String>>, role__niew: Option<Vec<String>>, role__nisw: Option<Vec<String>>, role__regex: Option<Vec<String>>, tag: Option<Vec<String>>, tag__n: Option<Vec<String>>, tag_id: Option<Vec<i32>>, tag_id__n: Option<Vec<i32>>, updated_by_request: Option<&str>, virtual_circuit_id: Option<Vec<i32>>, virtual_circuit_id__n: Option<Vec<i32>>) -> Result<crate::models::PaginatedVirtualCircuitTerminationList, Error<CircuitsVirtualCircuitTerminationsListError>> {
    let local_var_configuration = configuration;
    ...
    if let Some(ref local_var_str) = virtual_circuit_id__n {
        local_var_req_builder = match "multi" {
            "multi" => local_var_req_builder.query(&local_var_str.into_iter().map(|p| ("virtual_circuit_id__n".to_owned(), p.to_string())).collect::<Vec<(std::string::String, std::string::String)>>()),
            _ => local_var_req_builder.query(&[("virtual_circuit_id__n", &local_var_str.into_iter().map(|p| p.to_string()).collect::<Vec<String>>().join(",").to_string())]),
        };
    }
    if let Some(ref local_var_user_agent) = local_var_configuration.user_agent {
        local_var_req_builder = local_var_req_builder.header(reqwest::header::USER_AGENT, local_var_user_agent.clone());
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<CircuitsVirtualCircuitTerminationsListError> = serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Err(Error::ResponseError(local_var_error))
    }
}
...
pub async fn circuits_virtual_circuit_terminations_partial_update(configuration: &configuration::Configuration, id: i32, patched_writable_virtual_circuit_termination_request: Option<crate::models::PatchedWritableVirtualCircuitTerminationRequest>) -> Result<crate::models::VirtualCircuitTermination, Error<CircuitsVirtualCircuitTerminationsPartialUpdateError>> {
    let local_var_configuration = configuration;
    ...
    local_var_req_builder = local_var_req_builder.json(&patched_writable_virtual_circuit_termination_request);
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<CircuitsVirtualCircuitTerminationsPartialUpdateError> = serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Err(Error::ResponseError(local_var_error))
    }
}
...
/// Return all CablePaths which traverse a given pass-through port.
pub async fn circuits_virtual_circuit_terminations_paths_retrieve(configuration: &configuration::Configuration, id: i32) -> Result<crate::models::VirtualCircuitTermination, Error<CircuitsVirtualCircuitTerminationsPathsRetrieveError>> {
    let local_var_configuration = configuration;

    let local_var_client = &local_var_configuration.client;

    let local_var_uri_str = format!("{}/api/circuits/virtual-circuit-terminations/{id}/paths/", local_var_configuration.base_path, id=id);
    let mut local_var_req_builder = local_var_client.request(reqwest::Method::GET, local_var_uri_str.as_str());
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<CircuitsVirtualCircuitTerminationsPathsRetrieveError> = serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Err(Error::ResponseError(local_var_error))
    }
}
...
pub async fn circuits_virtual_circuit_terminations_retrieve(configuration: &configuration::Configuration, id: i32) -> Result<crate::models::VirtualCircuitTermination, Error<CircuitsVirtualCircuitTerminationsRetrieveError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<CircuitsVirtualCircuitTerminationsRetrieveError> = serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Err(Error::ResponseError(local_var_error))
    }
}
...
pub async fn circuits_virtual_circuit_terminations_update(configuration: &configuration::Configuration, id: i32, writable_virtual_circuit_termination_request: crate::models::WritableVirtualCircuitTerminationRequest) -> Result<crate::models::VirtualCircuitTermination, Error<CircuitsVirtualCircuitTerminationsUpdateError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<CircuitsVirtualCircuitTerminationsUpdateError> = serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Err(Error::ResponseError(local_var_error))
    }
}
...
pub async fn circuits_virtual_circuit_types_bulk_destroy(configuration: &configuration::Configuration, virtual_circuit_type_request: Vec<crate::models::VirtualCircuitTypeRequest>) -> Result<(), Error<CircuitsVirtualCircuitTypesBulkDestroyError>> {
    let local_var_configuration = configuration;

    let local_var_client = &local_var_configuration.client;

    let local_var_uri_str = format!("{}/api/circuits/virtual-circuit-types/", local_var_configuration.base_path);
    let mut local_var_req_builder = local_var_client.request(reqwest::Method::DELETE, local_var_uri_str.as_str());
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<CircuitsVirtualCircuitTypesBulkDestroyError> = serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Err(Error::ResponseError(local_var_error))
    }
}
...
pub async fn circuits_virtual_circuit_types_bulk_partial_update(configuration: &configuration::Configuration, virtual_circuit_type_request: Vec<crate::models::VirtualCircuitTypeRequest>) -> Result<Vec<crate::models::VirtualCircuitType>, Error<CircuitsVirtualCircuitTypesBulkPartialUpdateError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<CircuitsVirtualCircuitTypesBulkPartialUpdateError> = serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Err(Error::ResponseError(local_var_error))
    }
}
...
pub async fn circuits_virtual_circuit_types_bulk_update(configuration: &configuration::Configuration, virtual_circuit_type_request: Vec<crate::models::VirtualCircuitTypeRequest>) -> Result<Vec<crate::models::VirtualCircuitType>, Error<CircuitsVirtualCircuitTypesBulkUpdateError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<CircuitsVirtualCircuitTypesBulkUpdateError> = serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Err(Error::ResponseError(local_var_error))
    }
}
...
pub async fn circuits_virtual_circuit_types_create(configuration: &configuration::Configuration, virtual_circuit_type_request: crate::models::VirtualCircuitTypeRequest) -> Result<crate::models::VirtualCircuitType, Error<CircuitsVirtualCircuitTypesCreateError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<CircuitsVirtualCircuitTypesCreateError> = serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Err(Error::ResponseError(local_var_error))
    }
}
...
pub async fn circuits_virtual_circuit_types_destroy(configuration: &configuration::Configuration, id: i32) -> Result<(), Error<CircuitsVirtualCircuitTypesDestroyError>> {
    let local_var_configuration = configuration;

    let local_var_client = &local_var_configuration.client;

    let local_var_uri_str = format!("{}/api/circuits/virtual-circuit-types/{id}/", local_var_configuration.base_path, id=id);
    let mut local_var_req_builder = local_var_client.request(reqwest::Method::DELETE, local_var_uri_str.as_str());
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<CircuitsVirtualCircuitTypesDestroyError> = serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Err(Error::ResponseError(local_var_error))
    }
}
...
pub async fn circuits_virtual_circuit_types_list(configuration: &configuration::Configuration, color: Option<Vec<String>>, color__empty: Option<bool>, color__ic: Option<Vec<String>>, color__ie: Option<Vec<String>>, color__iew: Option<Vec<String>>, color__iregex: Option<Vec<String>>, color__isw: Option<Vec<String>>, color__n: Option<Vec<String>>, color__nic: Option<Vec<String>>, color__nie: Option<Vec<String>>, color__niew: Option<Vec<String>>, color__nisw: Option<Vec<String>>, color__regex: Option<Vec<String>>, created: Option<Vec<String>>, created__empty: Option<Vec<String>>, created__gt: Option<Vec<String>>, created__gte: Option<Vec<String>>, created__lt: Option<Vec<String>>, created__lte: Option<Vec<String>>, created__n: Option<Vec<String>>, created_by_request: Option<&str>, description: Option<Vec<String>>, description__empty: Option<bool>, description__ic: Option<Vec<String>>, description__ie: Option<Vec<String>>, description__iew: Option<Vec<String>>, description__iregex: Option<Vec<String>>, description__isw: Option<Vec<String>>, description__n: Option<Vec<String>>, description__nic: Option<Vec<String>>, description__nie: Option<Vec<String>>, description__niew: Option<Vec<String>>, description__nisw: Option<Vec<String>>, description__regex: Option<Vec<String>>, id: Option<Vec<i32>>, id__empty: Option<bool>, id__gt: Option<Vec<i32>>, id__gte: Option<Vec<i32>>, id__lt: Option<Vec<i32>>, id__lte: Option<Vec<i32>>, id__n: Option<Vec<i32>>, last_updated: Option<Vec<String>>, last_updated__empty: Option<Vec<String>>, last_updated__gt: Option<Vec<String>>, last_updated__gte: Option<Vec<String>>, last_updated__lt: Option<Vec<String>>, last_updated__lte: Option<Vec<String>>, last_updated__n: Option<Vec<String>>, limit: Option<i32>, modified_by_request: Option<&str>, name: Option<Vec<String>>, name__empty: Option<bool>, name__ic: Option<Vec<String>>, name__ie: Option<Vec<String>>, name__iew: Option<Vec<String>>, name__iregex: Option<Vec<String>>, name__isw: Option<Vec<String>>, name__n: Option<Vec<String>>, name__nic: Option<Vec<String>>, name__nie: Option<Vec<String>>, name__niew: Option<Vec<String>>, name__nisw: Option<Vec<String>>, name__regex: Option<Vec<String>>, offset: Option<i32>, ordering: Option<&str>, q: Option<&str>, slug: Option<Vec<String>>, slug__empty: Option<bool>, slug__ic: Option<Vec<String>>, slug__ie: Option<Vec<String>>, slug__iew: Option<Vec<String>>, slug__iregex: Option<Vec<String>>, slug__isw: Option<Vec<String>>, slug__n: Option<Vec<String>>, slug__nic: Option<Vec<String>>, slug__nie: Option<Vec<String>>, slug__niew: Option<Vec<String>>, slug__nisw: Option<Vec<String>>, slug__regex: Option<Vec<String>>, tag: Option<Vec<String>>, tag__n: Option<Vec<String>>, tag_id: Option<Vec<i32>>, tag_id__n: Option<Vec<i32>>, updated_by_request: Option<&str>) -> Result<crate::models::PaginatedVirtualCircuitTypeList, Error<CircuitsVirtualCircuitTypesListError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<CircuitsVirtualCircuitTypesListError> = serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Err(Error::ResponseError(local_var_error))
    }
}
...
pub async fn circuits_virtual_circuit_types_partial_update(configuration: &configuration::Configuration, id: i32, patched_virtual_circuit_type_request: Option<crate::models::PatchedVirtualCircuitTypeRequest>) -> Result<crate::models::VirtualCircuitType, Error<CircuitsVirtualCircuitTypesPartialUpdateError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<CircuitsVirtualCircuitTypesPartialUpdateError> = serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Err(Error::ResponseError(local_var_error))
    }
}
...
pub async fn circuits_virtual_circuit_types_retrieve(configuration: &configuration::Configuration, id: i32) -> Result<crate::models::VirtualCircuitType, Error<CircuitsVirtualCircuitTypesRetrieveError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<CircuitsVirtualCircuitTypesRetrieveError> = serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Err(Error::ResponseError(local_var_error))
    }
}
...
pub async fn circuits_virtual_circuit_types_update(configuration: &configuration::Configuration, id: i32, virtual_circuit_type_request: crate::models::VirtualCircuitTypeRequest) -> Result<crate::models::VirtualCircuitType, Error<CircuitsVirtualCircuitTypesUpdateError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<CircuitsVirtualCircuitTypesUpdateError> = serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Err(Error::ResponseError(local_var_error))
    }
}
...
pub async fn circuits_virtual_circuits_bulk_destroy(configuration: &configuration::Configuration, virtual_circuit_request: Vec<crate::models::VirtualCircuitRequest>) -> Result<(), Error<CircuitsVirtualCircuitsBulkDestroyError>> {
    let local_var_configuration = configuration;

    let local_var_client = &local_var_configuration.client;

    let local_var_uri_str = format!("{}/api/circuits/virtual-circuits/", local_var_configuration.base_path);
    let mut local_var_req_builder = local_var_client.request(reqwest::Method::DELETE, local_var_uri_str.as_str());
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<CircuitsVirtualCircuitsBulkDestroyError> = serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Err(Error::ResponseError(local_var_error))
    }
}
...
pub async fn circuits_virtual_circuits_bulk_partial_update(configuration: &configuration::Configuration, virtual_circuit_request: Vec<crate::models::VirtualCircuitRequest>) -> Result<Vec<crate::models::VirtualCircuit>, Error<CircuitsVirtualCircuitsBulkPartialUpdateError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<CircuitsVirtualCircuitsBulkPartialUpdateError> = serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Err(Error::ResponseError(local_var_error))
    }
}
...
pub async fn circuits_virtual_circuits_bulk_update(configuration: &configuration::Configuration, virtual_circuit_request: Vec<crate::models::VirtualCircuitRequest>) -> Result<Vec<crate::models::VirtualCircuit>, Error<CircuitsVirtualCircuitsBulkUpdateError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<CircuitsVirtualCircuitsBulkUpdateError> = serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Err(Error::ResponseError(local_var_error))
    }
}
...
pub async fn circuits_virtual_circuits_create(configuration: &configuration::Configuration, writable_virtual_circuit_request: crate::models::WritableVirtualCircuitRequest) -> Result<crate::models::VirtualCircuit, Error<CircuitsVirtualCircuitsCreateError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<CircuitsVirtualCircuitsCreateError> = serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Err(Error::ResponseError(local_var_error))
    }
}
...
pub async fn circuits_virtual_circuits_destroy(configuration: &configuration::Configuration, id: i32) -> Result<(), Error<CircuitsVirtualCircuitsDestroyError>> {
    let local_var_configuration = configuration;

    let local_var_client = &local_var_configuration.client;

    let local_var_uri_str = format!("{}/api/circuits/virtual-circuits/{id}/", local_var_configuration.base_path, id=id);
    let mut local_var_req_builder = local_var_client.request(reqwest::Method::DELETE, local_var_uri_str.as_str());
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<CircuitsVirtualCircuitsDestroyError> = serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Err(Error::ResponseError(local_var_error))
    }
}
...
pub async fn circuits_virtual_circuits_list(configuration: &configuration::Configuration, cid: Option<Vec<String>>, cid__empty: Option<bool>, cid__ic: Option<Vec<String>>, cid__ie: Option<Vec<String>>, cid__iew: Option<Vec<String>>, cid__iregex: Option<Vec<String>>, cid__isw: Option<Vec<String>>, cid__n: Option<Vec<String>>, cid__nic: Option<Vec<String>>, cid__nie: Option<Vec<String>>, cid__niew: Option<Vec<String>>, cid__nisw: Option<Vec<String>>, cid__regex: Option<Vec<String>>, created: Option<Vec<String>>, created__empty: Option<Vec<String>>, created__gt: Option<Vec<String>>, created__gte: Option<Vec<String>>, created__lt: Option<Vec<String>>, created__lte: Option<Vec<String>>, created__n: Option<Vec<String>>, created_by_request: Option<&str>, description: Option<Vec<String>>, description__empty: Option<bool>, description__ic: Option<Vec<String>>, description__ie: Option<Vec<String>>, description__iew: Option<Vec<String>>, description__iregex: Option<Vec<String>>, description__isw: Option<Vec<String>>, description__n: Option<Vec<String>>, description__nic: Option<Vec<String>>, description__nie: Option<Vec<String>>, description__niew: Option<Vec<String>>, description__nisw: Option<Vec<String>>, description__regex: Option<Vec<String>>, id: Option<Vec<i32>>, id__empty: Option<bool>, id__gt: Option<Vec<i32>>, id__gte: Option<Vec<i32>>, id__lt: Option<Vec<i32>>, id__lte: Option<Vec<i32>>, id__n: Option<Vec<i32>>, last_updated: Option<Vec<String>>, last_updated__empty: Option<Vec<String>>, last_updated__gt: Option<Vec<String>>, last_updated__gte: Option<Vec<String>>, last_updated__lt: Option<Vec<String>>, last_updated__lte: Option<Vec<String>>, last_updated__n: Option<Vec<String>>, limit: Option<i32>, modified_by_request: Option<&str>, offset: Option<i32>, ordering: Option<&str>, provider: Option<Vec<String>>, provider__n: Option<Vec<String>>, provider_account: Option<Vec<String>>, provider_account__n: Option<Vec<String>>, provider_account_id: Option<Vec<i32>>, provider_account_id__n: Option<Vec<i32>>, provider_id: Option<Vec<i32>>, provider_id__n: Option<Vec<i32>>, provider_network_id: Option<Vec<i32>>, provider_network_id__n: Option<Vec<i32>>, q: Option<&str>, status: Option<Vec<String>>, status__empty: Option<bool>, status__ic: Option<Vec<String>>, status__ie: Option<Vec<String>>, status__iew: Option<Vec<String>>, status__iregex: Option<Vec<String>>, status__isw: Option<Vec<String>>, status__n: Option<Vec<String>>, status__nic: Option<Vec<String>>, status__nie: Option<Vec<String>>, status__niew: Option<Vec<String>>, status__nisw: Option<Vec<String>>, status__regex: Option<Vec<String>>, tag: Option<Vec<String>>, tag__n: Option<Vec<String>>, tag_id: Option<Vec<i32>>, tag_id__n: Option<Vec<i32>>, tenant: Option<Vec<String>>, tenant__n: Option<Vec<String>>, tenant_group: Option<Vec<String>>, tenant_group__n: Option<Vec<String>>, tenant_group_id: Option<Vec<String>>, tenant_group_id__n: Option<Vec<String>>, tenant_id: Option<Vec<i32>>, tenant_id__n: Option<Vec<i32>>, r#type: Option<Vec<String>>, type__n: Option<Vec<String>>, type_id: Option<Vec<i32>>, type_id__n: Option<Vec<i32>>, updated_by_request: Option<&str>) -> Result<crate::models::PaginatedVirtualCircuitList, Error<CircuitsVirtualCircuitsListError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<CircuitsVirtualCircuitsListError> = serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Err(Error::ResponseError(local_var_error))
    }
}
...
pub async fn circuits_virtual_circuits_partial_update(configuration: &configuration::Configuration, id: i32, patched_writable_virtual_circuit_request: Option<crate::models::PatchedWritableVirtualCircuitRequest>) -> Result<crate::models::VirtualCircuit, Error<CircuitsVirtualCircuitsPartialUpdateError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<CircuitsVirtualCircuitsPartialUpdateError> = serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Err(Error::ResponseError(local_var_error))
    }
}
...
pub async fn circuits_virtual_circuits_retrieve(configuration: &configuration::Configuration, id: i32) -> Result<crate::models::VirtualCircuit, Error<CircuitsVirtualCircuitsRetrieveError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<CircuitsVirtualCircuitsRetrieveError> = serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Err(Error::ResponseError(local_var_error))
    }
}
...
pub async fn circuits_virtual_circuits_update(configuration: &configuration::Configuration, id: i32, writable_virtual_circuit_request: crate::models::WritableVirtualCircuitRequest) -> Result<crate::models::VirtualCircuit, Error<CircuitsVirtualCircuitsUpdateError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<CircuitsVirtualCircuitsUpdateError> = serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Err(Error::ResponseError(local_var_error))
    }
}
