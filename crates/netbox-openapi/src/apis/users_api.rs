...
pub async fn users_groups_list(configuration: &configuration::Configuration, description: Option<Vec<String>>, description__empty: Option<bool>, description__ic: Option<Vec<String>>, description__ie: Option<Vec<String>>, description__iew: Option<Vec<String>>, description__iregex: Option<Vec<String>>, description__isw: Option<Vec<String>>, description__n: Option<Vec<String>>, description__nic: Option<Vec<String>>, description__nie: Option<Vec<String>>, description__niew: Option<Vec<String>>, description__nisw: Option<Vec<String>>, description__regex: Option<Vec<String>>, id: Option<Vec<i32>>, id__empty: Option<bool>, id__gt: Option<Vec<i32>>, id__gte: Option<Vec<i32>>, id__lt: Option<Vec<i32>>, id__lte: Option<Vec<i32>>, id__n: Option<Vec<i32>>, limit: Option<i32>, name: Option<Vec<String>>, name__empty: Option<bool>, name__ic: Option<Vec<String>>, name__ie: Option<Vec<String>>, name__iew: Option<Vec<String>>, name__iregex: Option<Vec<String>>, name__isw: Option<Vec<String>>, name__n: Option<Vec<String>>, name__nic: Option<Vec<String>>, name__nie: Option<Vec<String>>, name__niew: Option<Vec<String>>, name__nisw: Option<Vec<String>>, name__regex: Option<Vec<String>>, notification_group_id: Option<Vec<i32>>, notification_group_id__n: Option<Vec<i32>>, offset: Option<i32>, ordering: Option<&str>, permission_id: Option<Vec<i32>>, permission_id__n: Option<Vec<i32>>, q: Option<&str>, user_id: Option<Vec<i32>>, user_id__n: Option<Vec<i32>>) -> Result<crate::models::PaginatedGroupList, Error<UsersGroupsListError>> {
    let local_var_configuration = configuration;
    ...
    if let Some(ref local_var_str) = notification_group_id {
        local_var_req_builder = match "multi" {
            "multi" => local_var_req_builder.query(&local_var_str.into_iter().map(|p| ("notification_group_id".to_owned(), p.to_string())).collect::<Vec<(std::string::String, std::string::String)>>()),
            _ => local_var_req_builder.query(&[("notification_group_id", &local_var_str.into_iter().map(|p| p.to_string()).collect::<Vec<String>>().join(",").to_string())]),
        };
    }
    if let Some(ref local_var_str) = notification_group_id__n {
        local_var_req_builder = match "multi" {
            "multi" => local_var_req_builder.query(&local_var_str.into_iter().map(|p| ("notification_group_id__n".to_owned(), p.to_string())).collect::<Vec<(std::string::String, std::string::String)>>()),
            _ => local_var_req_builder.query(&[("notification_group_id__n", &local_var_str.into_iter().map(|p| p.to_string()).collect::<Vec<String>>().join(",").to_string())]),
        };
    }
    ...
    if let Some(ref local_var_str) = permission_id {
        local_var_req_builder = match "multi" {
            "multi" => local_var_req_builder.query(&local_var_str.into_iter().map(|p| ("permission_id".to_owned(), p.to_string())).collect::<Vec<(std::string::String, std::string::String)>>()),
            _ => local_var_req_builder.query(&[("permission_id", &local_var_str.into_iter().map(|p| p.to_string()).collect::<Vec<String>>().join(",").to_string())]),
        };
    }
    if let Some(ref local_var_str) = permission_id__n {
        local_var_req_builder = match "multi" {
            "multi" => local_var_req_builder.query(&local_var_str.into_iter().map(|p| ("permission_id__n".to_owned(), p.to_string())).collect::<Vec<(std::string::String, std::string::String)>>()),
            _ => local_var_req_builder.query(&[("permission_id__n", &local_var_str.into_iter().map(|p| p.to_string()).collect::<Vec<String>>().join(",").to_string())]),
        };
    }
...
pub async fn users_permissions_create(configuration: &configuration::Configuration, object_permission_request: crate::models::ObjectPermissionRequest) -> Result<crate::models::ObjectPermission, Error<UsersPermissionsCreateError>> {
    let local_var_configuration = configuration;
...
pub async fn users_permissions_list(configuration: &configuration::Configuration, can_add: Option<bool>, can_change: Option<bool>, can_delete: Option<bool>, can_view: Option<bool>, description: Option<Vec<String>>, description__empty: Option<bool>, description__ic: Option<Vec<String>>, description__ie: Option<Vec<String>>, description__iew: Option<Vec<String>>, description__iregex: Option<Vec<String>>, description__isw: Option<Vec<String>>, description__n: Option<Vec<String>>, description__nic: Option<Vec<String>>, description__nie: Option<Vec<String>>, description__niew: Option<Vec<String>>, description__nisw: Option<Vec<String>>, description__regex: Option<Vec<String>>, enabled: Option<bool>, group: Option<Vec<String>>, group__n: Option<Vec<String>>, group_id: Option<Vec<i32>>, group_id__n: Option<Vec<i32>>, id: Option<Vec<i32>>, id__empty: Option<bool>, id__gt: Option<Vec<i32>>, id__gte: Option<Vec<i32>>, id__lt: Option<Vec<i32>>, id__lte: Option<Vec<i32>>, id__n: Option<Vec<i32>>, limit: Option<i32>, name: Option<Vec<String>>, name__empty: Option<bool>, name__ic: Option<Vec<String>>, name__ie: Option<Vec<String>>, name__iew: Option<Vec<String>>, name__iregex: Option<Vec<String>>, name__isw: Option<Vec<String>>, name__n: Option<Vec<String>>, name__nic: Option<Vec<String>>, name__nie: Option<Vec<String>>, name__niew: Option<Vec<String>>, name__nisw: Option<Vec<String>>, name__regex: Option<Vec<String>>, object_type: Option<&str>, object_type__ic: Option<&str>, object_type__ie: Option<&str>, object_type__iew: Option<&str>, object_type__iregex: Option<&str>, object_type__isw: Option<&str>, object_type__n: Option<&str>, object_type__nic: Option<&str>, object_type__nie: Option<&str>, object_type__niew: Option<&str>, object_type__nisw: Option<&str>, object_type__regex: Option<&str>, object_type_id: Option<Vec<i32>>, object_type_id__n: Option<Vec<i32>>, object_types: Option<Vec<i32>>, object_types__n: Option<Vec<i32>>, offset: Option<i32>, ordering: Option<&str>, q: Option<&str>, user: Option<Vec<String>>, user__n: Option<Vec<String>>, user_id: Option<Vec<i32>>, user_id__n: Option<Vec<i32>>) -> Result<crate::models::PaginatedObjectPermissionList, Error<UsersPermissionsListError>> {
    let local_var_configuration = configuration;
    ...
    if let Some(ref local_var_str) = object_type__ic {
        local_var_req_builder = local_var_req_builder.query(&[("object_type__ic", &local_var_str.to_string())]);
    }
    if let Some(ref local_var_str) = object_type__ie {
        local_var_req_builder = local_var_req_builder.query(&[("object_type__ie", &local_var_str.to_string())]);
    }
    if let Some(ref local_var_str) = object_type__iew {
        local_var_req_builder = local_var_req_builder.query(&[("object_type__iew", &local_var_str.to_string())]);
    }
    if let Some(ref local_var_str) = object_type__iregex {
        local_var_req_builder = local_var_req_builder.query(&[("object_type__iregex", &local_var_str.to_string())]);
    }
    if let Some(ref local_var_str) = object_type__isw {
        local_var_req_builder = local_var_req_builder.query(&[("object_type__isw", &local_var_str.to_string())]);
    }
    ...
    if let Some(ref local_var_str) = object_type__nic {
        local_var_req_builder = local_var_req_builder.query(&[("object_type__nic", &local_var_str.to_string())]);
    }
    if let Some(ref local_var_str) = object_type__nie {
        local_var_req_builder = local_var_req_builder.query(&[("object_type__nie", &local_var_str.to_string())]);
    }
    if let Some(ref local_var_str) = object_type__niew {
        local_var_req_builder = local_var_req_builder.query(&[("object_type__niew", &local_var_str.to_string())]);
    }
    if let Some(ref local_var_str) = object_type__nisw {
        local_var_req_builder = local_var_req_builder.query(&[("object_type__nisw", &local_var_str.to_string())]);
    }
    if let Some(ref local_var_str) = object_type__regex {
        local_var_req_builder = local_var_req_builder.query(&[("object_type__regex", &local_var_str.to_string())]);
    }
...
pub async fn users_permissions_partial_update(configuration: &configuration::Configuration, id: i32, patched_object_permission_request: Option<crate::models::PatchedObjectPermissionRequest>) -> Result<crate::models::ObjectPermission, Error<UsersPermissionsPartialUpdateError>> {
    let local_var_configuration = configuration;
...
pub async fn users_permissions_update(configuration: &configuration::Configuration, id: i32, object_permission_request: crate::models::ObjectPermissionRequest) -> Result<crate::models::ObjectPermission, Error<UsersPermissionsUpdateError>> {
    let local_var_configuration = configuration;
...
pub async fn users_tokens_create(configuration: &configuration::Configuration, token_request: crate::models::TokenRequest) -> Result<crate::models::Token, Error<UsersTokensCreateError>> {
    let local_var_configuration = configuration;
...
pub async fn users_tokens_list(configuration: &configuration::Configuration, created: Option<String>, created__gte: Option<String>, created__lte: Option<String>, description: Option<Vec<String>>, description__empty: Option<bool>, description__ic: Option<Vec<String>>, description__ie: Option<Vec<String>>, description__iew: Option<Vec<String>>, description__iregex: Option<Vec<String>>, description__isw: Option<Vec<String>>, description__n: Option<Vec<String>>, description__nic: Option<Vec<String>>, description__nie: Option<Vec<String>>, description__niew: Option<Vec<String>>, description__nisw: Option<Vec<String>>, description__regex: Option<Vec<String>>, expires: Option<String>, expires__gte: Option<String>, expires__lte: Option<String>, id: Option<Vec<i32>>, id__empty: Option<bool>, id__gt: Option<Vec<i32>>, id__gte: Option<Vec<i32>>, id__lt: Option<Vec<i32>>, id__lte: Option<Vec<i32>>, id__n: Option<Vec<i32>>, key: Option<Vec<String>>, key__empty: Option<bool>, key__ic: Option<Vec<String>>, key__ie: Option<Vec<String>>, key__iew: Option<Vec<String>>, key__iregex: Option<Vec<String>>, key__isw: Option<Vec<String>>, key__n: Option<Vec<String>>, key__nic: Option<Vec<String>>, key__nie: Option<Vec<String>>, key__niew: Option<Vec<String>>, key__nisw: Option<Vec<String>>, key__regex: Option<Vec<String>>, last_used: Option<Vec<String>>, last_used__empty: Option<bool>, last_used__gt: Option<Vec<String>>, last_used__gte: Option<Vec<String>>, last_used__lt: Option<Vec<String>>, last_used__lte: Option<Vec<String>>, last_used__n: Option<Vec<String>>, limit: Option<i32>, offset: Option<i32>, ordering: Option<&str>, q: Option<&str>, user: Option<Vec<String>>, user__n: Option<Vec<String>>, user_id: Option<Vec<i32>>, user_id__n: Option<Vec<i32>>, write_enabled: Option<bool>) -> Result<crate::models::PaginatedTokenList, Error<UsersTokensListError>> {
    let local_var_configuration = configuration;
    ...
    if let Some(ref local_var_str) = key__iregex {
        local_var_req_builder = match "multi" {
            "multi" => local_var_req_builder.query(&local_var_str.into_iter().map(|p| ("key__iregex".to_owned(), p.to_string())).collect::<Vec<(std::string::String, std::string::String)>>()),
            _ => local_var_req_builder.query(&[("key__iregex", &local_var_str.into_iter().map(|p| p.to_string()).collect::<Vec<String>>().join(",").to_string())]),
        };
    }
    ...
    if let Some(ref local_var_str) = key__regex {
        local_var_req_builder = match "multi" {
            "multi" => local_var_req_builder.query(&local_var_str.into_iter().map(|p| ("key__regex".to_owned(), p.to_string())).collect::<Vec<(std::string::String, std::string::String)>>()),
            _ => local_var_req_builder.query(&[("key__regex", &local_var_str.into_iter().map(|p| p.to_string()).collect::<Vec<String>>().join(",").to_string())]),
        };
    }
    if let Some(ref local_var_str) = last_used {
        local_var_req_builder = match "multi" {
            "multi" => local_var_req_builder.query(&local_var_str.into_iter().map(|p| ("last_used".to_owned(), p.to_string())).collect::<Vec<(std::string::String, std::string::String)>>()),
            _ => local_var_req_builder.query(&[("last_used", &local_var_str.into_iter().map(|p| p.to_string()).collect::<Vec<String>>().join(",").to_string())]),
        };
    }
    if let Some(ref local_var_str) = last_used__empty {
        local_var_req_builder = local_var_req_builder.query(&[("last_used__empty", &local_var_str.to_string())]);
    }
    if let Some(ref local_var_str) = last_used__gt {
        local_var_req_builder = match "multi" {
            "multi" => local_var_req_builder.query(&local_var_str.into_iter().map(|p| ("last_used__gt".to_owned(), p.to_string())).collect::<Vec<(std::string::String, std::string::String)>>()),
            _ => local_var_req_builder.query(&[("last_used__gt", &local_var_str.into_iter().map(|p| p.to_string()).collect::<Vec<String>>().join(",").to_string())]),
        };
    }
    if let Some(ref local_var_str) = last_used__gte {
        local_var_req_builder = match "multi" {
            "multi" => local_var_req_builder.query(&local_var_str.into_iter().map(|p| ("last_used__gte".to_owned(), p.to_string())).collect::<Vec<(std::string::String, std::string::String)>>()),
            _ => local_var_req_builder.query(&[("last_used__gte", &local_var_str.into_iter().map(|p| p.to_string()).collect::<Vec<String>>().join(",").to_string())]),
        };
    }
    if let Some(ref local_var_str) = last_used__lt {
        local_var_req_builder = match "multi" {
            "multi" => local_var_req_builder.query(&local_var_str.into_iter().map(|p| ("last_used__lt".to_owned(), p.to_string())).collect::<Vec<(std::string::String, std::string::String)>>()),
            _ => local_var_req_builder.query(&[("last_used__lt", &local_var_str.into_iter().map(|p| p.to_string()).collect::<Vec<String>>().join(",").to_string())]),
        };
    }
    if let Some(ref local_var_str) = last_used__lte {
        local_var_req_builder = match "multi" {
            "multi" => local_var_req_builder.query(&local_var_str.into_iter().map(|p| ("last_used__lte".to_owned(), p.to_string())).collect::<Vec<(std::string::String, std::string::String)>>()),
            _ => local_var_req_builder.query(&[("last_used__lte", &local_var_str.into_iter().map(|p| p.to_string()).collect::<Vec<String>>().join(",").to_string())]),
        };
    }
    if let Some(ref local_var_str) = last_used__n {
        local_var_req_builder = match "multi" {
            "multi" => local_var_req_builder.query(&local_var_str.into_iter().map(|p| ("last_used__n".to_owned(), p.to_string())).collect::<Vec<(std::string::String, std::string::String)>>()),
            _ => local_var_req_builder.query(&[("last_used__n", &local_var_str.into_iter().map(|p| p.to_string()).collect::<Vec<String>>().join(",").to_string())]),
        };
    }
    if let Some(ref local_var_str) = limit {
        local_var_req_builder = local_var_req_builder.query(&[("limit", &local_var_str.to_string())]);
...
pub async fn users_tokens_partial_update(configuration: &configuration::Configuration, id: i32, patched_token_request: Option<crate::models::PatchedTokenRequest>) -> Result<crate::models::Token, Error<UsersTokensPartialUpdateError>> {
    let local_var_configuration = configuration;
...
pub async fn users_tokens_provision_create(configuration: &configuration::Configuration, token_provision_request: crate::models::TokenProvisionRequest) -> Result<crate::models::TokenProvision, Error<UsersTokensProvisionCreateError>> {
    let local_var_configuration = configuration;
...
/// Put a token object.
pub async fn users_tokens_update(configuration: &configuration::Configuration, id: i32, token_request: crate::models::TokenRequest) -> Result<crate::models::Token, Error<UsersTokensUpdateError>> {
    let local_var_configuration = configuration;
...
pub async fn users_users_create(configuration: &configuration::Configuration, user_request: crate::models::UserRequest) -> Result<crate::models::User, Error<UsersUsersCreateError>> {
    let local_var_configuration = configuration;
...
pub async fn users_users_list(configuration: &configuration::Configuration, date_joined: Option<Vec<String>>, date_joined__empty: Option<bool>, date_joined__gt: Option<Vec<String>>, date_joined__gte: Option<Vec<String>>, date_joined__lt: Option<Vec<String>>, date_joined__lte: Option<Vec<String>>, date_joined__n: Option<Vec<String>>, email: Option<Vec<String>>, email__empty: Option<bool>, email__ic: Option<Vec<String>>, email__ie: Option<Vec<String>>, email__iew: Option<Vec<String>>, email__iregex: Option<Vec<String>>, email__isw: Option<Vec<String>>, email__n: Option<Vec<String>>, email__nic: Option<Vec<String>>, email__nie: Option<Vec<String>>, email__niew: Option<Vec<String>>, email__nisw: Option<Vec<String>>, email__regex: Option<Vec<String>>, first_name: Option<Vec<String>>, first_name__empty: Option<bool>, first_name__ic: Option<Vec<String>>, first_name__ie: Option<Vec<String>>, first_name__iew: Option<Vec<String>>, first_name__iregex: Option<Vec<String>>, first_name__isw: Option<Vec<String>>, first_name__n: Option<Vec<String>>, first_name__nic: Option<Vec<String>>, first_name__nie: Option<Vec<String>>, first_name__niew: Option<Vec<String>>, first_name__nisw: Option<Vec<String>>, first_name__regex: Option<Vec<String>>, group: Option<Vec<String>>, group__n: Option<Vec<String>>, group_id: Option<Vec<i32>>, group_id__n: Option<Vec<i32>>, id: Option<Vec<i32>>, id__empty: Option<bool>, id__gt: Option<Vec<i32>>, id__gte: Option<Vec<i32>>, id__lt: Option<Vec<i32>>, id__lte: Option<Vec<i32>>, id__n: Option<Vec<i32>>, is_active: Option<bool>, is_staff: Option<bool>, is_superuser: Option<bool>, last_login: Option<Vec<String>>, last_login__empty: Option<bool>, last_login__gt: Option<Vec<String>>, last_login__gte: Option<Vec<String>>, last_login__lt: Option<Vec<String>>, last_login__lte: Option<Vec<String>>, last_login__n: Option<Vec<String>>, last_name: Option<Vec<String>>, last_name__empty: Option<bool>, last_name__ic: Option<Vec<String>>, last_name__ie: Option<Vec<String>>, last_name__iew: Option<Vec<String>>, last_name__iregex: Option<Vec<String>>, last_name__isw: Option<Vec<String>>, last_name__n: Option<Vec<String>>, last_name__nic: Option<Vec<String>>, last_name__nie: Option<Vec<String>>, last_name__niew: Option<Vec<String>>, last_name__nisw: Option<Vec<String>>, last_name__regex: Option<Vec<String>>, limit: Option<i32>, notification_group_id: Option<Vec<i32>>, notification_group_id__n: Option<Vec<i32>>, offset: Option<i32>, ordering: Option<&str>, permission_id: Option<Vec<i32>>, permission_id__n: Option<Vec<i32>>, q: Option<&str>, username: Option<Vec<String>>, username__empty: Option<bool>, username__ic: Option<Vec<String>>, username__ie: Option<Vec<String>>, username__iew: Option<Vec<String>>, username__iregex: Option<Vec<String>>, username__isw: Option<Vec<String>>, username__n: Option<Vec<String>>, username__nic: Option<Vec<String>>, username__nie: Option<Vec<String>>, username__niew: Option<Vec<String>>, username__nisw: Option<Vec<String>>, username__regex: Option<Vec<String>>) -> Result<crate::models::PaginatedUserList, Error<UsersUsersListError>> {
    let local_var_configuration = configuration;
    ...
    if let Some(ref local_var_str) = date_joined {
        local_var_req_builder = match "multi" {
            "multi" => local_var_req_builder.query(&local_var_str.into_iter().map(|p| ("date_joined".to_owned(), p.to_string())).collect::<Vec<(std::string::String, std::string::String)>>()),
            _ => local_var_req_builder.query(&[("date_joined", &local_var_str.into_iter().map(|p| p.to_string()).collect::<Vec<String>>().join(",").to_string())]),
        };
    }
    if let Some(ref local_var_str) = date_joined__empty {
        local_var_req_builder = local_var_req_builder.query(&[("date_joined__empty", &local_var_str.to_string())]);
    }
    if let Some(ref local_var_str) = date_joined__gt {
        local_var_req_builder = match "multi" {
            "multi" => local_var_req_builder.query(&local_var_str.into_iter().map(|p| ("date_joined__gt".to_owned(), p.to_string())).collect::<Vec<(std::string::String, std::string::String)>>()),
            _ => local_var_req_builder.query(&[("date_joined__gt", &local_var_str.into_iter().map(|p| p.to_string()).collect::<Vec<String>>().join(",").to_string())]),
        };
    }
    if let Some(ref local_var_str) = date_joined__gte {
        local_var_req_builder = match "multi" {
            "multi" => local_var_req_builder.query(&local_var_str.into_iter().map(|p| ("date_joined__gte".to_owned(), p.to_string())).collect::<Vec<(std::string::String, std::string::String)>>()),
            _ => local_var_req_builder.query(&[("date_joined__gte", &local_var_str.into_iter().map(|p| p.to_string()).collect::<Vec<String>>().join(",").to_string())]),
        };
    }
    if let Some(ref local_var_str) = date_joined__lt {
        local_var_req_builder = match "multi" {
            "multi" => local_var_req_builder.query(&local_var_str.into_iter().map(|p| ("date_joined__lt".to_owned(), p.to_string())).collect::<Vec<(std::string::String, std::string::String)>>()),
            _ => local_var_req_builder.query(&[("date_joined__lt", &local_var_str.into_iter().map(|p| p.to_string()).collect::<Vec<String>>().join(",").to_string())]),
        };
    }
    if let Some(ref local_var_str) = date_joined__lte {
        local_var_req_builder = match "multi" {
            "multi" => local_var_req_builder.query(&local_var_str.into_iter().map(|p| ("date_joined__lte".to_owned(), p.to_string())).collect::<Vec<(std::string::String, std::string::String)>>()),
            _ => local_var_req_builder.query(&[("date_joined__lte", &local_var_str.into_iter().map(|p| p.to_string()).collect::<Vec<String>>().join(",").to_string())]),
        };
    }
    if let Some(ref local_var_str) = date_joined__n {
        local_var_req_builder = match "multi" {
            "multi" => local_var_req_builder.query(&local_var_str.into_iter().map(|p| ("date_joined__n".to_owned(), p.to_string())).collect::<Vec<(std::string::String, std::string::String)>>()),
            _ => local_var_req_builder.query(&[("date_joined__n", &local_var_str.into_iter().map(|p| p.to_string()).collect::<Vec<String>>().join(",").to_string())]),
        };
    }
    ...
    if let Some(ref local_var_str) = email__iregex {
        local_var_req_builder = match "multi" {
            "multi" => local_var_req_builder.query(&local_var_str.into_iter().map(|p| ("email__iregex".to_owned(), p.to_string())).collect::<Vec<(std::string::String, std::string::String)>>()),
            _ => local_var_req_builder.query(&[("email__iregex", &local_var_str.into_iter().map(|p| p.to_string()).collect::<Vec<String>>().join(",").to_string())]),
        };
    }
    ...
    if let Some(ref local_var_str) = email__regex {
        local_var_req_builder = match "multi" {
            "multi" => local_var_req_builder.query(&local_var_str.into_iter().map(|p| ("email__regex".to_owned(), p.to_string())).collect::<Vec<(std::string::String, std::string::String)>>()),
            _ => local_var_req_builder.query(&[("email__regex", &local_var_str.into_iter().map(|p| p.to_string()).collect::<Vec<String>>().join(",").to_string())]),
        };
    }
    ...
    if let Some(ref local_var_str) = first_name__iregex {
        local_var_req_builder = match "multi" {
            "multi" => local_var_req_builder.query(&local_var_str.into_iter().map(|p| ("first_name__iregex".to_owned(), p.to_string())).collect::<Vec<(std::string::String, std::string::String)>>()),
            _ => local_var_req_builder.query(&[("first_name__iregex", &local_var_str.into_iter().map(|p| p.to_string()).collect::<Vec<String>>().join(",").to_string())]),
        };
    }
    ...
    if let Some(ref local_var_str) = first_name__regex {
        local_var_req_builder = match "multi" {
            "multi" => local_var_req_builder.query(&local_var_str.into_iter().map(|p| ("first_name__regex".to_owned(), p.to_string())).collect::<Vec<(std::string::String, std::string::String)>>()),
            _ => local_var_req_builder.query(&[("first_name__regex", &local_var_str.into_iter().map(|p| p.to_string()).collect::<Vec<String>>().join(",").to_string())]),
        };
    }
    if let Some(ref local_var_str) = group {
        local_var_req_builder = match "multi" {
    ...
    if let Some(ref local_var_str) = last_login {
        local_var_req_builder = match "multi" {
            "multi" => local_var_req_builder.query(&local_var_str.into_iter().map(|p| ("last_login".to_owned(), p.to_string())).collect::<Vec<(std::string::String, std::string::String)>>()),
            _ => local_var_req_builder.query(&[("last_login", &local_var_str.into_iter().map(|p| p.to_string()).collect::<Vec<String>>().join(",").to_string())]),
        };
    }
    if let Some(ref local_var_str) = last_login__empty {
        local_var_req_builder = local_var_req_builder.query(&[("last_login__empty", &local_var_str.to_string())]);
    }
    if let Some(ref local_var_str) = last_login__gt {
        local_var_req_builder = match "multi" {
            "multi" => local_var_req_builder.query(&local_var_str.into_iter().map(|p| ("last_login__gt".to_owned(), p.to_string())).collect::<Vec<(std::string::String, std::string::String)>>()),
            _ => local_var_req_builder.query(&[("last_login__gt", &local_var_str.into_iter().map(|p| p.to_string()).collect::<Vec<String>>().join(",").to_string())]),
        };
    }
    if let Some(ref local_var_str) = last_login__gte {
        local_var_req_builder = match "multi" {
            "multi" => local_var_req_builder.query(&local_var_str.into_iter().map(|p| ("last_login__gte".to_owned(), p.to_string())).collect::<Vec<(std::string::String, std::string::String)>>()),
            _ => local_var_req_builder.query(&[("last_login__gte", &local_var_str.into_iter().map(|p| p.to_string()).collect::<Vec<String>>().join(",").to_string())]),
        };
    }
    if let Some(ref local_var_str) = last_login__lt {
        local_var_req_builder = match "multi" {
            "multi" => local_var_req_builder.query(&local_var_str.into_iter().map(|p| ("last_login__lt".to_owned(), p.to_string())).collect::<Vec<(std::string::String, std::string::String)>>()),
            _ => local_var_req_builder.query(&[("last_login__lt", &local_var_str.into_iter().map(|p| p.to_string()).collect::<Vec<String>>().join(",").to_string())]),
        };
    }
    if let Some(ref local_var_str) = last_login__lte {
        local_var_req_builder = match "multi" {
            "multi" => local_var_req_builder.query(&local_var_str.into_iter().map(|p| ("last_login__lte".to_owned(), p.to_string())).collect::<Vec<(std::string::String, std::string::String)>>()),
            _ => local_var_req_builder.query(&[("last_login__lte", &local_var_str.into_iter().map(|p| p.to_string()).collect::<Vec<String>>().join(",").to_string())]),
        };
    }
    if let Some(ref local_var_str) = last_login__n {
        local_var_req_builder = match "multi" {
            "multi" => local_var_req_builder.query(&local_var_str.into_iter().map(|p| ("last_login__n".to_owned(), p.to_string())).collect::<Vec<(std::string::String, std::string::String)>>()),
            _ => local_var_req_builder.query(&[("last_login__n", &local_var_str.into_iter().map(|p| p.to_string()).collect::<Vec<String>>().join(",").to_string())]),
        };
    }
    ...
    if let Some(ref local_var_str) = last_name__iregex {
        local_var_req_builder = match "multi" {
            "multi" => local_var_req_builder.query(&local_var_str.into_iter().map(|p| ("last_name__iregex".to_owned(), p.to_string())).collect::<Vec<(std::string::String, std::string::String)>>()),
            _ => local_var_req_builder.query(&[("last_name__iregex", &local_var_str.into_iter().map(|p| p.to_string()).collect::<Vec<String>>().join(",").to_string())]),
        };
    }
    ...
    if let Some(ref local_var_str) = last_name__regex {
        local_var_req_builder = match "multi" {
            "multi" => local_var_req_builder.query(&local_var_str.into_iter().map(|p| ("last_name__regex".to_owned(), p.to_string())).collect::<Vec<(std::string::String, std::string::String)>>()),
            _ => local_var_req_builder.query(&[("last_name__regex", &local_var_str.into_iter().map(|p| p.to_string()).collect::<Vec<String>>().join(",").to_string())]),
        };
    }
    if let Some(ref local_var_str) = limit {
        local_var_req_builder = local_var_req_builder.query(&[("limit", &local_var_str.to_string())]);
    ...
    if let Some(ref local_var_str) = username__iregex {
        local_var_req_builder = match "multi" {
            "multi" => local_var_req_builder.query(&local_var_str.into_iter().map(|p| ("username__iregex".to_owned(), p.to_string())).collect::<Vec<(std::string::String, std::string::String)>>()),
            _ => local_var_req_builder.query(&[("username__iregex", &local_var_str.into_iter().map(|p| p.to_string()).collect::<Vec<String>>().join(",").to_string())]),
        };
    }
    ...
    if let Some(ref local_var_str) = username__regex {
        local_var_req_builder = match "multi" {
            "multi" => local_var_req_builder.query(&local_var_str.into_iter().map(|p| ("username__regex".to_owned(), p.to_string())).collect::<Vec<(std::string::String, std::string::String)>>()),
            _ => local_var_req_builder.query(&[("username__regex", &local_var_str.into_iter().map(|p| p.to_string()).collect::<Vec<String>>().join(",").to_string())]),
        };
    }
    if let Some(ref local_var_user_agent) = local_var_configuration.user_agent {
        local_var_req_builder = local_var_req_builder.header(reqwest::header::USER_AGENT, local_var_user_agent.clone());
...
/// Patch a user object.
pub async fn users_users_partial_update(configuration: &configuration::Configuration, id: i32, patched_user_request: Option<crate::models::PatchedUserRequest>) -> Result<crate::models::User, Error<UsersUsersPartialUpdateError>> {
    let local_var_configuration = configuration;
...
/// Put a user object.
pub async fn users_users_update(configuration: &configuration::Configuration, id: i32, user_request: crate::models::UserRequest) -> Result<crate::models::User, Error<UsersUsersUpdateError>> {
    let local_var_configuration = configuration;
