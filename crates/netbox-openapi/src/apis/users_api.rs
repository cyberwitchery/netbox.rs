...
pub async fn users_permissions_list(
    ...
    if let Some(ref local_var_str) = object_type__ic {
        local_var_req_builder =
            local_var_req_builder.query(&[("object_type__ic", &local_var_str.to_string())]);
    }
    if let Some(ref local_var_str) = object_type__ie {
        local_var_req_builder =
            local_var_req_builder.query(&[("object_type__ie", &local_var_str.to_string())]);
    }
    if let Some(ref local_var_str) = object_type__iew {
        local_var_req_builder =
            local_var_req_builder.query(&[("object_type__iew", &local_var_str.to_string())]);
    }
    if let Some(ref local_var_str) = object_type__iregex {
        local_var_req_builder =
            local_var_req_builder.query(&[("object_type__iregex", &local_var_str.to_string())]);
    }
    if let Some(ref local_var_str) = object_type__isw {
        local_var_req_builder =
            local_var_req_builder.query(&[("object_type__isw", &local_var_str.to_string())]);
    }
    ...
    if let Some(ref local_var_str) = object_type__nic {
        local_var_req_builder =
            local_var_req_builder.query(&[("object_type__nic", &local_var_str.to_string())]);
    }
    if let Some(ref local_var_str) = object_type__nie {
        local_var_req_builder =
            local_var_req_builder.query(&[("object_type__nie", &local_var_str.to_string())]);
    }
    if let Some(ref local_var_str) = object_type__niew {
        local_var_req_builder =
            local_var_req_builder.query(&[("object_type__niew", &local_var_str.to_string())]);
    }
    if let Some(ref local_var_str) = object_type__nisw {
        local_var_req_builder =
            local_var_req_builder.query(&[("object_type__nisw", &local_var_str.to_string())]);
    }
    if let Some(ref local_var_str) = object_type__regex {
        local_var_req_builder =
            local_var_req_builder.query(&[("object_type__regex", &local_var_str.to_string())]);
    }
...
pub async fn users_tokens_list(
    ...
    last_used: Option<Vec<String>>,
    last_used__empty: Option<bool>,
    last_used__gt: Option<Vec<String>>,
    last_used__gte: Option<Vec<String>>,
    last_used__lt: Option<Vec<String>>,
    last_used__lte: Option<Vec<String>>,
    last_used__n: Option<Vec<String>>,
    limit: Option<i32>,
    offset: Option<i32>,
    ordering: Option<&str>,
    q: Option<&str>,
    ...
    if let Some(ref local_var_str) = last_used {
        local_var_req_builder = match "multi" {
            "multi" => local_var_req_builder.query(
                &local_var_str
                    .into_iter()
                    .map(|p| ("last_used".to_owned(), p.to_string()))
                    .collect::<Vec<(std::string::String, std::string::String)>>(),
            ),
            _ => local_var_req_builder.query(&[(
                "last_used",
    ...
    if let Some(ref local_var_str) = last_used__empty {
        local_var_req_builder =
            local_var_req_builder.query(&[("last_used__empty", &local_var_str.to_string())]);
    }
    if let Some(ref local_var_str) = last_used__gt {
        local_var_req_builder = match "multi" {
            "multi" => local_var_req_builder.query(
                &local_var_str
                    .into_iter()
                    .map(|p| ("last_used__gt".to_owned(), p.to_string()))
                    .collect::<Vec<(std::string::String, std::string::String)>>(),
            ),
            _ => local_var_req_builder.query(&[(
                "last_used__gt",
    ...
    if let Some(ref local_var_str) = last_used__gte {
        local_var_req_builder = match "multi" {
            "multi" => local_var_req_builder.query(
                &local_var_str
                    .into_iter()
                    .map(|p| ("last_used__gte".to_owned(), p.to_string()))
                    .collect::<Vec<(std::string::String, std::string::String)>>(),
            ),
            _ => local_var_req_builder.query(&[(
                "last_used__gte",
    ...
    if let Some(ref local_var_str) = last_used__lt {
        local_var_req_builder = match "multi" {
            "multi" => local_var_req_builder.query(
                &local_var_str
                    .into_iter()
                    .map(|p| ("last_used__lt".to_owned(), p.to_string()))
                    .collect::<Vec<(std::string::String, std::string::String)>>(),
            ),
            _ => local_var_req_builder.query(&[(
                "last_used__lt",
    ...
    if let Some(ref local_var_str) = last_used__lte {
        local_var_req_builder = match "multi" {
            "multi" => local_var_req_builder.query(
                &local_var_str
                    .into_iter()
                    .map(|p| ("last_used__lte".to_owned(), p.to_string()))
                    .collect::<Vec<(std::string::String, std::string::String)>>(),
            ),
            _ => local_var_req_builder.query(&[(
                "last_used__lte",
    ...
    if let Some(ref local_var_str) = last_used__n {
        local_var_req_builder = match "multi" {
            "multi" => local_var_req_builder.query(
                &local_var_str
                    .into_iter()
                    .map(|p| ("last_used__n".to_owned(), p.to_string()))
                    .collect::<Vec<(std::string::String, std::string::String)>>(),
            ),
            _ => local_var_req_builder.query(&[(
                "last_used__n",
