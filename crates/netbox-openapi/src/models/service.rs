...
pub struct Service {
    ...
    pub protocol: Option<Option<Box<crate::models::ServiceProtocol>>>,
    ...
    pub ipaddresses: Option<Vec<crate::models::BriefIpAddress>>,
...
impl Service {
    ...
    pub fn new(parent_object_type: String, parent_object_id: i64, name: String) -> Service {
        Service {
            id: None,
            url: None,
            display_url: None,
