...
impl WritableCircuitGroupAssignmentRequest {
    ...
    pub fn new(group: crate::models::BriefCircuitGroupAssignmentSerializerRequestGroup, member_type: String, member_id: i64) -> WritableCircuitGroupAssignmentRequest {
