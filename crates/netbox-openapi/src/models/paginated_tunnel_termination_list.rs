...
pub struct PaginatedTunnelTerminationList {
    ...
    pub results: Vec<crate::models::TunnelTermination>,
}

impl PaginatedTunnelTerminationList {
    pub fn new(count: i32, results: Vec<crate::models::TunnelTermination>) -> PaginatedTunnelTerminationList {
