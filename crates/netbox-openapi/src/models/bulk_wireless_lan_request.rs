...
pub struct BulkWirelessLanRequest {
    #[serde(rename = "id")]
    pub id: i32,
    #[serde(rename = "ssid")]
    pub ssid: String,
    ...
    pub group: Option<Option<Box<crate::models::BulkWirelessLanRequestGroup>>>,
...
impl BulkWirelessLanRequest {
    /// Base serializer class for models inheriting from PrimaryModel.
    pub fn new(id: i32, ssid: String) -> BulkWirelessLanRequest {
