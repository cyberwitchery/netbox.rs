...
pub struct PaginatedVirtualCircuitList {
    ...
    pub results: Vec<crate::models::VirtualCircuit>,
}

impl PaginatedVirtualCircuitList {
    pub fn new(count: i32, results: Vec<crate::models::VirtualCircuit>) -> PaginatedVirtualCircuitList {
