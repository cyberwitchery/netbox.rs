...
impl RackType {
    ...
    pub fn new(id: i32, url: String, display_url: String, display: String, manufacturer: crate::models::BriefManufacturer, model: String, slug: String, created: Option<String>, last_updated: Option<String>) -> RackType {
        RackType {
            id,
            url,
            display_url,
