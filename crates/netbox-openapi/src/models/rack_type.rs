...
pub struct RackType {
    ...
    pub form_factor: Box<crate::models::RackTypeFormFactor>,
    ...
    pub cooling_capability: Option<Option<Box<crate::models::RackCoolingCapability>>>,
    /// Cooling capacity (kW)
    #[serde(
...
impl RackType {
    ...
    pub fn new(
        ...
        model: String,
        slug: String,
        form_factor: crate::models::RackTypeFormFactor,
    ) -> RackType {
        RackType {
            id: None,
            url: None,
            ...
            slug,
            description: None,
            form_factor: Box::new(form_factor),
            width: None,
            u_height: None,
            starting_unit: None,
            desc_units: None,
