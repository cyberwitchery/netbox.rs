...
pub struct PaginatedIpSecProfileList {
    ...
    pub results: Vec<crate::models::IpSecProfile>,
}

impl PaginatedIpSecProfileList {
    pub fn new(count: i32, results: Vec<crate::models::IpSecProfile>) -> PaginatedIpSecProfileList {
