...
impl Vlan {
    ...
    pub fn new(id: i32, url: String, display_url: String, display: String, vid: i32, name: String, l2vpn_termination: Option<crate::models::BriefL2VpnTermination>, created: Option<String>, last_updated: Option<String>, prefix_count: i64) -> Vlan {
        Vlan {
            id,
            url,
            display_url,
