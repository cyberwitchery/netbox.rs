...
pub struct PaginatedModuleTypeProfileList {
    ...
    pub results: Vec<crate::models::ModuleTypeProfile>,
}

impl PaginatedModuleTypeProfileList {
    pub fn new(count: i32, results: Vec<crate::models::ModuleTypeProfile>) -> PaginatedModuleTypeProfileList {
