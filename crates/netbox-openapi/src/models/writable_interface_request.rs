...
pub struct WritableInterfaceRequest {
    ...
    #[serde(rename = "rf_channel", default, with = "::serde_with::rust::double_option", skip_serializing_if = "Option::is_none")]
    ...
    pub vlan_translation_policy: Option<Option<Box<crate::models::InterfaceRequestVlanTranslationPolicy>>>,
...
impl WritableInterfaceRequest {
    ...
    pub fn new(device: crate::models::BriefInterfaceRequestDevice, name: String, r#type: RHashType) -> WritableInterfaceRequest {
