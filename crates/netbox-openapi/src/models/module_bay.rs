...
impl ModuleBay {
    ...
    pub fn new(id: i32, url: String, display_url: String, display: String, device: crate::models::BriefDevice, name: String, created: Option<String>, last_updated: Option<String>) -> ModuleBay {
        ModuleBay {
            id,
            url,
            display_url,
