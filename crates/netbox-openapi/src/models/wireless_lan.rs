...
impl WirelessLan {
    ...
    pub fn new(id: i32, url: String, display_url: String, display: String, ssid: String, scope: Option<serde_json::Value>, created: Option<String>, last_updated: Option<String>) -> WirelessLan {
        WirelessLan {
            id,
            url,
            display_url,
