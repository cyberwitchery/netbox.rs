...
pub struct WritableCustomFieldChoiceSetRequest {
    ...
    #[serde(rename = "base_choices", default, with = "::serde_with::rust::double_option", skip_serializing_if = "Option::is_none")]
...
impl WritableCustomFieldChoiceSetRequest {
    ...
    pub fn new(name: String, extra_choices: Vec<Vec<serde_json::Value>>) -> WritableCustomFieldChoiceSetRequest {
