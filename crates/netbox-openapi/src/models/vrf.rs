...
impl Vrf {
    ...
    pub fn new(id: i32, url: String, display_url: String, display: String, name: String, created: Option<String>, last_updated: Option<String>, ipaddress_count: i64, prefix_count: i64) -> Vrf {
        Vrf {
            id,
            url,
            display_url,
