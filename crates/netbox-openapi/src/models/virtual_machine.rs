...
pub struct VirtualMachine {
    ...
    pub status: Option<Box<crate::models::VirtualMachineStatus>>,
    #[serde(rename = "start_on_boot", skip_serializing_if = "Option::is_none")]
    pub start_on_boot: Option<Box<crate::models::VirtualMachineStartOnBoot>>,
    #[serde(
        rename = "site",
        default,
        with = "::serde_with::rust::double_option",
...
impl VirtualMachine {
    ...
    pub fn new(name: String) -> VirtualMachine {
        VirtualMachine {
            id: None,
            url: None,
            display_url: None,
