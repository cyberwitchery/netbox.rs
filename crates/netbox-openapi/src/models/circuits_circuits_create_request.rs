...
pub struct CircuitsCircuitsCreateRequest {
    /// Unique circuit ID
    #[serde(rename = "cid")]
    pub cid: String,
    ...
    #[serde(rename = "type")]
    pub r#type: Box<crate::models::BulkCircuitRequestType>,
...
impl CircuitsCircuitsCreateRequest {
    pub fn new(
        cid: String,
        provider: crate::models::BriefCircuitRequestProvider,
        r#type: crate::models::BulkCircuitRequestType,
