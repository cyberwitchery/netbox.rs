...
pub struct BulkInterfaceTemplateRequest {
    #[serde(rename = "id")]
    pub id: i32,
    #[serde(
        rename = "device_type",
    ...
    pub parent: Option<Option<Box<crate::models::NestedInterfaceTemplateRequest>>>,
    #[serde(
        rename = "bridge",
        default,
        with = "::serde_with::rust::double_option",
...
impl BulkInterfaceTemplateRequest {
    /// Extends the built-in ModelSerializer to enforce calling full_clean() on a copy of the associated instance during validation. (DRF does not do this by default; see <https://github.com/encode/django-rest-framework/issues/3144>)
    pub fn new(id: i32, name: String, r#type: RHashType) -> BulkInterfaceTemplateRequest {
