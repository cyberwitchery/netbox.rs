...
pub struct Tunnel {
    ...
    #[serde(rename = "terminations_count")]
    pub terminations_count: i64,
}

impl Tunnel {
    /// Adds support for custom fields and tags.
    pub fn new(id: i32, url: String, display_url: String, display: String, name: String, status: crate::models::TunnelStatus, encapsulation: crate::models::TunnelEncapsulation, created: Option<String>, last_updated: Option<String>, terminations_count: i64) -> Tunnel {
        Tunnel {
            id,
            url,
            display_url,
