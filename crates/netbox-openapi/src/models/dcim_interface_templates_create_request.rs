...
pub struct DcimInterfaceTemplatesCreateRequest {
    #[serde(
        rename = "device_type",
        default,
...
impl DcimInterfaceTemplatesCreateRequest {
    pub fn new(name: String, r#type: RHashType) -> DcimInterfaceTemplatesCreateRequest {
