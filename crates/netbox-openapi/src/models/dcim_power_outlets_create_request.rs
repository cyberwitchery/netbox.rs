...
pub struct DcimPowerOutletsCreateRequest {
    #[serde(rename = "device")]
    ...
    pub power_port: Option<Option<Box<crate::models::BulkPowerOutletRequestPowerPort>>>,
...
impl DcimPowerOutletsCreateRequest {
    pub fn new(
