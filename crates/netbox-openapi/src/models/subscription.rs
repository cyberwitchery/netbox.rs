...
impl Subscription {
    ...
    pub fn new(id: i32, url: String, display: String, object_type: String, object_id: i64, object: Option<serde_json::Value>, user: crate::models::BriefUser, created: String) -> Subscription {
        Subscription {
            id,
            url,
            display,
