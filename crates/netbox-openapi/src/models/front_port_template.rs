...
impl FrontPortTemplate {
    ...
    pub fn new(id: i32, url: String, display: String, name: String, r#type: crate::models::FrontPortType, rear_port: crate::models::BriefRearPortTemplate, created: Option<String>, last_updated: Option<String>) -> FrontPortTemplate {
        FrontPortTemplate {
            id,
            url,
            display,
