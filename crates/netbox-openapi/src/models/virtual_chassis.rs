...
impl VirtualChassis {
    ...
    pub fn new(id: i32, url: String, display_url: String, display: String, name: String, created: Option<String>, last_updated: Option<String>, member_count: i32, members: Vec<crate::models::NestedDevice>) -> VirtualChassis {
        VirtualChassis {
            id,
            url,
            display_url,
