...
pub struct DcimConsolePortTemplatesCreateRequest {
    #[serde(
        rename = "device_type",
        default,
...
impl DcimConsolePortTemplatesCreateRequest {
    pub fn new(name: String) -> DcimConsolePortTemplatesCreateRequest {
