...
impl DeviceWithConfigContext {
    ...
    pub fn new(id: i32, url: String, display_url: String, display: String, device_type: crate::models::BriefDeviceType, role: crate::models::BriefDeviceRole, site: crate::models::BriefSite, parent_device: Option<crate::models::NestedDevice>, primary_ip: Option<crate::models::BriefIpAddress>, config_context: Option<serde_json::Value>, created: Option<String>, last_updated: Option<String>, console_port_count: i32, console_server_port_count: i32, power_port_count: i32, power_outlet_count: i32, interface_count: i32, front_port_count: i32, rear_port_count: i32, device_bay_count: i32, module_bay_count: i32, inventory_item_count: i32) -> DeviceWithConfigContext {
