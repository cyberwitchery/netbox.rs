...
pub struct PaginatedVirtualCircuitTypeList {
    ...
    pub results: Vec<crate::models::VirtualCircuitType>,
}

impl PaginatedVirtualCircuitTypeList {
    pub fn new(count: i32, results: Vec<crate::models::VirtualCircuitType>) -> PaginatedVirtualCircuitTypeList {
