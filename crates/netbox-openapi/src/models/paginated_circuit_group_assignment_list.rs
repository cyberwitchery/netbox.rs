...
pub struct PaginatedCircuitGroupAssignmentList {
    ...
    pub results: Vec<crate::models::CircuitGroupAssignment>,
}

impl PaginatedCircuitGroupAssignmentList {
    pub fn new(count: i32, results: Vec<crate::models::CircuitGroupAssignment>) -> PaginatedCircuitGroupAssignmentList {
