...
impl PowerPanel {
    ...
    pub fn new(id: i32, url: String, display_url: String, display: String, site: crate::models::BriefSite, name: String, powerfeed_count: i64, created: Option<String>, last_updated: Option<String>) -> PowerPanel {
        PowerPanel {
            id,
            url,
            display_url,
