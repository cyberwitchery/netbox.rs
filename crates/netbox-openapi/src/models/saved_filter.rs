...
impl SavedFilter {
    ...
    pub fn new(id: i32, url: String, display_url: String, display: String, object_types: Vec<String>, name: String, slug: String, parameters: Option<serde_json::Value>, created: Option<String>, last_updated: Option<String>) -> SavedFilter {
        SavedFilter {
            id,
            url,
            display_url,
