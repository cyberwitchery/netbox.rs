...
pub enum Value {
    ...
    Variant1Period6tbaseCr8,
    #[serde(rename = "1.6tbase-dr8")]
    Variant1Period6tbaseDr8,
    #[serde(rename = "1.6tbase-dr8-2")]
    Variant1Period6tbaseDr82,
    ...
    #[serde(rename = "100gbase-x-sfp112")]
    Variant100gbaseXSfp112,
    ...
    Variant1Period6tbaseXOsfp1600,
    #[serde(rename = "1.6tbase-x-osfp1600-rhs")]
    Variant1Period6tbaseXOsfp1600Rhs,
    #[serde(rename = "1.6tbase-x-qsfpdd1600")]
    Variant1Period6tbaseXQsfpdd1600,
    ...
    InfinibandXdr,
    #[serde(rename = "infiniband-hdr-2x")]
    InfinibandHdr2x,
    #[serde(rename = "infiniband-ndr-2x")]
    InfinibandNdr2x,
    #[serde(rename = "infiniband-xdr-2x")]
    InfinibandXdr2x,
    #[serde(rename = "infiniband-sdr-4x")]
    InfinibandSdr4x,
    #[serde(rename = "infiniband-ddr-4x")]
    InfinibandDdr4x,
    #[serde(rename = "infiniband-qdr-4x")]
    InfinibandQdr4x,
    #[serde(rename = "infiniband-fdr10-4x")]
    InfinibandFdr104x,
    #[serde(rename = "infiniband-fdr-4x")]
    InfinibandFdr4x,
    #[serde(rename = "infiniband-edr-4x")]
    InfinibandEdr4x,
    #[serde(rename = "infiniband-hdr-4x")]
    InfinibandHdr4x,
    #[serde(rename = "infiniband-ndr-4x")]
    InfinibandNdr4x,
    #[serde(rename = "infiniband-xdr-4x")]
    InfinibandXdr4x,
    #[serde(rename = "t1")]
    T1,
    #[serde(rename = "e1")]
    ...
    #[serde(rename = "hpe-synergy-interconnect-link")]
    HpeSynergyInterconnectLink,
    #[serde(rename = "other")]
    Other,
}
...
pub enum Label {
    ...
    #[serde(rename = "10GBASE-CU (10GE DAC Passive Twinax)")]
    Variant10GbaseCuLeftParenthesis10GeDacPassiveTwinaxRightParenthesis,
    ...
    #[serde(rename = "40GBASE-SR4 (40GE BiDi)")]
    Variant40GbaseSr4LeftParenthesis40GeBiDiRightParenthesis,
    ...
    #[serde(rename = "1.6TBASE-CR8 (1.6TE)")]
    Variant1Period6TbaseCr8LeftParenthesis1Period6TeRightParenthesis,
    #[serde(rename = "1.6TBASE-DR8 (1.6TE)")]
    Variant1Period6TbaseDr8LeftParenthesis1Period6TeRightParenthesis,
    #[serde(rename = "1.6TBASE-DR8-2 (1.6TE)")]
    Variant1Period6TbaseDr82LeftParenthesis1Period6TeRightParenthesis,
    ...
    #[serde(rename = "SFP (2.5GE)")]
    SfpLeftParenthesis2Period5GeRightParenthesis,
    ...
    #[serde(rename = "SFP112 (100GE)")]
    Sfp112LeftParenthesis100GeRightParenthesis,
    ...
    #[serde(rename = "OSFP1600 (1.6TE)")]
    Osfp1600LeftParenthesis1Period6TeRightParenthesis,
    #[serde(rename = "OSFP1600-RHS (1.6TE)")]
    Osfp1600RhsLeftParenthesis1Period6TeRightParenthesis,
    #[serde(rename = "QSFP-DD1600 (1.6TE)")]
    QsfpDd1600LeftParenthesis1Period6TeRightParenthesis,
    ...
    #[serde(rename = "1.6TBASE-KR8 (1.6TE)")]
    Variant1Period6TbaseKr8LeftParenthesis1Period6TeRightParenthesis,
    ...
    #[serde(rename = "XDR (200 Gbps)")]
    XdrLeftParenthesis200GbpsRightParenthesis,
    #[serde(rename = "HDR 2X (100 Gbps)")]
    Hdr2XLeftParenthesis100GbpsRightParenthesis,
    #[serde(rename = "NDR 2X (200 Gbps)")]
    Ndr2XLeftParenthesis200GbpsRightParenthesis,
    #[serde(rename = "XDR 2X (400 Gbps)")]
    Xdr2XLeftParenthesis400GbpsRightParenthesis,
    #[serde(rename = "SDR 4X (8 Gbps)")]
    Sdr4XLeftParenthesis8GbpsRightParenthesis,
    #[serde(rename = "DDR 4X (16 Gbps)")]
    Ddr4XLeftParenthesis16GbpsRightParenthesis,
    #[serde(rename = "QDR 4X (32 Gbps)")]
    Qdr4XLeftParenthesis32GbpsRightParenthesis,
    #[serde(rename = "FDR10 4X (40 Gbps)")]
    Fdr104XLeftParenthesis40GbpsRightParenthesis,
    #[serde(rename = "FDR 4X (56 Gbps)")]
    Fdr4XLeftParenthesis56GbpsRightParenthesis,
    #[serde(rename = "EDR 4X (100 Gbps)")]
    Edr4XLeftParenthesis100GbpsRightParenthesis,
    #[serde(rename = "HDR 4X (200 Gbps)")]
    Hdr4XLeftParenthesis200GbpsRightParenthesis,
    #[serde(rename = "NDR 4X (400 Gbps)")]
    Ndr4XLeftParenthesis400GbpsRightParenthesis,
    #[serde(rename = "XDR 4X (800 Gbps)")]
    Xdr4XLeftParenthesis800GbpsRightParenthesis,
