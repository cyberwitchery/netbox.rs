...
pub struct PaginatedTunnelGroupList {
    ...
    pub results: Vec<crate::models::TunnelGroup>,
}

impl PaginatedTunnelGroupList {
    pub fn new(count: i32, results: Vec<crate::models::TunnelGroup>) -> PaginatedTunnelGroupList {
