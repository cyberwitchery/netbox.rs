...
impl CustomLink {
    ...
    pub fn new(id: i32, url: String, display_url: String, display: String, object_types: Vec<String>, name: String, link_text: String, link_url: String, created: Option<String>, last_updated: Option<String>) -> CustomLink {
        CustomLink {
            id,
            url,
            display_url,
