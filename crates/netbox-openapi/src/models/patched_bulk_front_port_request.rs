...
pub struct PatchedBulkFrontPortRequest {
    #[serde(rename = "id")]
    pub id: i32,
    ...
    pub rear_ports: Option<Vec<crate::models::FrontPortMappingRequest>>,
...
impl PatchedBulkFrontPortRequest {
    /// Adds an `owner` field for models which have a ForeignKey to users.Owner.
    pub fn new(id: i32) -> PatchedBulkFrontPortRequest {
