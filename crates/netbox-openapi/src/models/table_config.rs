...
impl TableConfig {
    ...
    pub fn new(id: i32, url: String, display_url: String, display: String, object_type: String, table: String, name: String, columns: Vec<String>, created: Option<String>, last_updated: Option<String>) -> TableConfig {
        TableConfig {
            id,
            url,
            display_url,
