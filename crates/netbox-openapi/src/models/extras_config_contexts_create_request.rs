...
pub struct ExtrasConfigContextsCreateRequest {
    #[serde(rename = "name")]
    pub name: String,
...
impl ExtrasConfigContextsCreateRequest {
    pub fn new(name: String, data: Option<serde_json::Value>) -> ExtrasConfigContextsCreateRequest {
