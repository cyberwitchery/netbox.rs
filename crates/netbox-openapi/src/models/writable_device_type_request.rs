...
pub struct WritableDeviceTypeRequest {
    ...
    pub default_platform: Option<Option<Box<crate::models::DeviceTypeRequestDefaultPlatform>>>,
    #[serde(rename = "model")]
    pub model: String,
    #[serde(rename = "slug")]
    pub slug: String,
    ...
    #[serde(rename = "front_image", default, with = "::serde_with::rust::double_option", skip_serializing_if = "Option::is_none")]
    pub front_image: Option<Option<std::path::PathBuf>>,
    #[serde(rename = "rear_image", default, with = "::serde_with::rust::double_option", skip_serializing_if = "Option::is_none")]
...
impl WritableDeviceTypeRequest {
    ...
    pub fn new(manufacturer: crate::models::BriefDeviceTypeRequestManufacturer, model: String, slug: String) -> WritableDeviceTypeRequest {
