...
pub struct Device {
    ...
    #[serde(
        rename = "cooling_intake_count",
        skip_serializing_if = "Option::is_none"
    )]
    pub cooling_intake_count: Option<i32>,
    #[serde(
        rename = "cooling_outflow_count",
        skip_serializing_if = "Option::is_none"
    )]
    pub cooling_outflow_count: Option<i32>,
...
impl Device {
    ...
    pub fn new(
        ...
        Device {
            ...
            cooling_intake_count: None,
            cooling_outflow_count: None,
