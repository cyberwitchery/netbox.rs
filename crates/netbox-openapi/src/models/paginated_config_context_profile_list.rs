...
pub struct PaginatedConfigContextProfileList {
    ...
    pub results: Vec<crate::models::ConfigContextProfile>,
}

impl PaginatedConfigContextProfileList {
    pub fn new(count: i32, results: Vec<crate::models::ConfigContextProfile>) -> PaginatedConfigContextProfileList {
