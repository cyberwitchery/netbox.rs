...
impl CableTermination {
    ...
    pub fn new(id: i32, url: String, display: String, cable: i32, cable_end: CableEnd, termination_type: String, termination_id: i64, termination: Option<serde_json::Value>, created: Option<String>, last_updated: Option<String>) -> CableTermination {
        CableTermination {
            id,
            url,
            display,
