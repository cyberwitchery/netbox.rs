...
impl DeviceWithConfigContextRequest {
    ...
    pub fn new(device_type: crate::models::DeviceBayTemplateRequestDeviceType, role: crate::models::DeviceWithConfigContextRequestRole, site: crate::models::DeviceWithConfigContextRequestSite) -> DeviceWithConfigContextRequest {
