...
impl ConfigContextProfile {
    ...
    pub fn new(id: i32, url: String, display_url: String, display: String, name: String, data_path: String, data_file: crate::models::BriefDataFile, data_synced: Option<String>, created: Option<String>, last_updated: Option<String>) -> ConfigContextProfile {
