...
pub struct Cluster {
    ...
    #[serde(rename = "allocated_vcpus")]
    pub allocated_vcpus: f64,
    #[serde(rename = "allocated_memory")]
    pub allocated_memory: i32,
    #[serde(rename = "allocated_disk")]
    pub allocated_disk: i32,
}

impl Cluster {
    /// Adds support for custom fields and tags.
    pub fn new(id: i32, url: String, display_url: String, display: String, name: String, r#type: crate::models::BriefClusterType, scope: Option<serde_json::Value>, created: Option<String>, last_updated: Option<String>, device_count: i64, virtualmachine_count: i64, allocated_vcpus: f64, allocated_memory: i32, allocated_disk: i32) -> Cluster {
        Cluster {
            id,
            url,
            display_url,
