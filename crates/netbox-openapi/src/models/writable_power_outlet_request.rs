...
pub struct WritablePowerOutletRequest {
    ...
    pub power_port: Option<Option<Box<crate::models::PatchedWritablePowerOutletRequestPowerPort>>>,
...
impl WritablePowerOutletRequest {
    ...
    pub fn new(device: crate::models::BriefInterfaceRequestDevice, name: String) -> WritablePowerOutletRequest {
