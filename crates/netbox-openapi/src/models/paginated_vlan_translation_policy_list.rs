...
pub struct PaginatedVlanTranslationPolicyList {
    ...
    pub results: Vec<crate::models::VlanTranslationPolicy>,
}

impl PaginatedVlanTranslationPolicyList {
    pub fn new(count: i32, results: Vec<crate::models::VlanTranslationPolicy>) -> PaginatedVlanTranslationPolicyList {
