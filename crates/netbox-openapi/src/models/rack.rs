...
impl Rack {
    ...
    pub fn new(id: i32, url: String, display_url: String, display: String, name: String, site: crate::models::BriefSite, created: Option<String>, last_updated: Option<String>, device_count: i64, powerfeed_count: i64) -> Rack {
        Rack {
            id,
            url,
            display_url,
