...
impl IpAddress {
    ...
    pub fn new(id: i32, url: String, display_url: String, display: String, family: crate::models::AggregateFamily, address: String, assigned_object: Option<serde_json::Value>, nat_outside: Vec<crate::models::NestedIpAddress>, created: Option<String>, last_updated: Option<String>) -> IpAddress {
        IpAddress {
            id,
            url,
            display_url,
