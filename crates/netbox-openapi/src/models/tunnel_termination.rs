...
impl TunnelTermination {
    ...
    pub fn new(id: i32, url: String, display_url: String, display: String, tunnel: crate::models::BriefTunnel, role: crate::models::TunnelTerminationRole, termination_type: String, termination: Option<serde_json::Value>, created: Option<String>, last_updated: Option<String>) -> TunnelTermination {
        TunnelTermination {
            id,
            url,
            display_url,
