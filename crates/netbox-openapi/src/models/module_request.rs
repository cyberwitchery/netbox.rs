...
impl ModuleRequest {
    ...
    pub fn new(device: crate::models::BriefInterfaceRequestDevice, module_bay: crate::models::NestedModuleBayRequest, module_type: crate::models::ModuleRequestModuleType) -> ModuleRequest {
        ModuleRequest {
