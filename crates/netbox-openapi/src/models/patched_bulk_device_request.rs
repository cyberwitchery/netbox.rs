...
pub struct PatchedBulkDeviceRequest {
    #[serde(rename = "id")]
    pub id: i32,
    #[serde(
        rename = "name",
    ...
    pub device_type: Option<Box<crate::models::BulkDeviceBayTemplateRequestDeviceType>>,
    #[serde(rename = "role", skip_serializing_if = "Option::is_none")]
    pub role: Option<Box<crate::models::BulkDeviceRequestRole>>,
    #[serde(
        rename = "tenant",
        default,
        with = "::serde_with::rust::double_option",
    ...
    pub site: Option<Box<crate::models::BulkCoolingSourceRequestSite>>,
    #[serde(
        rename = "location",
        default,
        with = "::serde_with::rust::double_option",
...
impl PatchedBulkDeviceRequest {
    /// Base serializer class for models inheriting from PrimaryModel.
    pub fn new(id: i32) -> PatchedBulkDeviceRequest {
