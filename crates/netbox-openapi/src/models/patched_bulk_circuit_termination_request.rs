...
pub struct PatchedBulkCircuitTerminationRequest {
    #[serde(rename = "id")]
    pub id: i32,
    #[serde(rename = "circuit", skip_serializing_if = "Option::is_none")]
    pub circuit: Option<Box<crate::models::BulkCircuitTerminationRequestCircuit>>,
    /// * `A` - A * `Z` - Z
...
impl PatchedBulkCircuitTerminationRequest {
    /// Adds support for custom fields and tags.
    pub fn new(id: i32) -> PatchedBulkCircuitTerminationRequest {
