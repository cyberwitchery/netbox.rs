...
pub struct DcimPowerOutletTemplatesCreateRequest {
    #[serde(
        rename = "device_type",
        default,
    ...
    pub color: Option<Box<crate::models::BriefModuleBayTypeColor>>,
    #[serde(
        rename = "power_port",
        default,
        with = "::serde_with::rust::double_option",
    ...
    pub power_port: Option<Option<Box<crate::models::BulkPowerOutletTemplateRequestPowerPort>>>,
...
impl DcimPowerOutletTemplatesCreateRequest {
    pub fn new(name: String) -> DcimPowerOutletTemplatesCreateRequest {
...
pub enum RHashType {
    ...
    #[serde(rename = "usb-c")]
    UsbC,
    #[serde(rename = "molex-micro-fit-1x2")]
    MolexMicroFit1x2,
    #[serde(rename = "molex-micro-fit-2x2")]
    MolexMicroFit2x2,
    #[serde(rename = "molex-micro-fit-2x3")]
    MolexMicroFit2x3,
    #[serde(rename = "molex-micro-fit-2x4")]
    MolexMicroFit2x4,
