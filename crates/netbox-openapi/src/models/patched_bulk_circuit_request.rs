...
pub struct PatchedBulkCircuitRequest {
    #[serde(rename = "id")]
    pub id: i32,
    /// Unique circuit ID
    ...
    pub r#type: Option<Box<crate::models::BulkCircuitRequestType>>,
...
impl PatchedBulkCircuitRequest {
    /// Base serializer class for models inheriting from PrimaryModel.
    pub fn new(id: i32) -> PatchedBulkCircuitRequest {
