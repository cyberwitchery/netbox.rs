...
impl VmInterface {
    ...
    pub fn new(id: i32, url: String, display_url: String, display: String, virtual_machine: crate::models::BriefVirtualMachine, name: String, mac_address: Option<String>, mac_addresses: Option<Vec<crate::models::BriefMacAddress>>, l2vpn_termination: Option<crate::models::BriefL2VpnTermination>, created: Option<String>, last_updated: Option<String>, count_ipaddresses: i32, count_fhrp_groups: i32) -> VmInterface {
        VmInterface {
            id,
            url,
            display_url,
