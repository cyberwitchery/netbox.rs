...
pub struct DcimSitesCreateRequest {
    ...
    pub region: Option<Option<Box<crate::models::BulkSiteRequestRegion>>>,
    #[serde(
        rename = "group",
        default,
        with = "::serde_with::rust::double_option",
    ...
    pub group: Option<Option<Box<crate::models::BulkSiteRequestGroup>>>,
    #[serde(
        rename = "tenant",
        default,
        with = "::serde_with::rust::double_option",
...
impl DcimSitesCreateRequest {
    pub fn new(name: String, slug: String) -> DcimSitesCreateRequest {
