...
impl Location {
    ...
    pub fn new(id: i32, url: String, display_url: String, display: String, name: String, slug: String, site: crate::models::BriefSite, created: Option<String>, last_updated: Option<String>, rack_count: i32, device_count: i32, prefix_count: i64, _depth: i32) -> Location {
        Location {
            id,
            url,
            display_url,
