...
impl ContactAssignment {
    ...
    pub fn new(id: i32, url: String, display: String, object_type: String, object_id: i64, object: ::std::collections::HashMap<String, serde_json::Value>, contact: crate::models::BriefContact, created: Option<String>, last_updated: Option<String>) -> ContactAssignment {
        ContactAssignment {
            id,
            url,
            display,
