...
pub struct WritableFrontPortTemplateRequest {
    ...
    pub rear_port: Box<crate::models::FrontPortTemplateRequestRearPort>,
...
impl WritableFrontPortTemplateRequest {
    ...
    pub fn new(name: String, r#type: RHashType, rear_port: crate::models::FrontPortTemplateRequestRearPort) -> WritableFrontPortTemplateRequest {
