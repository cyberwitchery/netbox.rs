...
pub struct PaginatedVlanTranslationRuleList {
    ...
    pub results: Vec<crate::models::VlanTranslationRule>,
}

impl PaginatedVlanTranslationRuleList {
    pub fn new(count: i32, results: Vec<crate::models::VlanTranslationRule>) -> PaginatedVlanTranslationRuleList {
