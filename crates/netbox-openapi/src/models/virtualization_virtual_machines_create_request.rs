...
pub struct VirtualizationVirtualMachinesCreateRequest {
    #[serde(rename = "name")]
    pub name: String,
    #[serde(rename = "virtual_machine_type", default, with = "::serde_with::rust::double_option", skip_serializing_if = "Option::is_none")]
    pub virtual_machine_type: Option<Option<Box<crate::models::PatchedWritableVirtualMachineWithConfigContextRequestVirtualMachineType>>>,
    #[serde(rename = "role", default, with = "::serde_with::rust::double_option", skip_serializing_if = "Option::is_none")]
    pub role: Option<Option<Box<crate::models::PatchedWritableVirtualMachineWithConfigContextRequestRole>>>,
    ...
    pub site: Option<Option<Box<crate::models::CreateAvailableVlanRequestSite>>>,
...
impl VirtualizationVirtualMachinesCreateRequest {
    pub fn new(name: String) -> VirtualizationVirtualMachinesCreateRequest {
