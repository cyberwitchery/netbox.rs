...
pub struct PaginatedVirtualCircuitTerminationList {
    ...
    pub results: Vec<crate::models::VirtualCircuitTermination>,
}

impl PaginatedVirtualCircuitTerminationList {
    pub fn new(count: i32, results: Vec<crate::models::VirtualCircuitTermination>) -> PaginatedVirtualCircuitTerminationList {
