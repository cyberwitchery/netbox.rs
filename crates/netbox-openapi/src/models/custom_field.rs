...
pub struct CustomField {
    ...
    #[serde(rename = "related_object_type", default, with = "::serde_with::rust::double_option", skip_serializing_if = "Option::is_none")]
    ...
    #[serde(rename = "related_object_filter", default, with = "::serde_with::rust::double_option", skip_serializing_if = "Option::is_none")]
...
impl CustomField {
    ...
    pub fn new(id: i32, url: String, display_url: String, display: String, object_types: Vec<String>, r#type: crate::models::CustomFieldType, data_type: String, name: String, created: Option<String>, last_updated: Option<String>) -> CustomField {
        CustomField {
            id,
            url,
            display_url,
