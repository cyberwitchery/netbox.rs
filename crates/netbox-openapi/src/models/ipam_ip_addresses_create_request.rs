...
pub struct IpamIpAddressesCreateRequest {
    ...
    pub dns_name: Option<Box<crate::models::BriefIpAddressDnsName>>,
...
impl IpamIpAddressesCreateRequest {
    pub fn new(address: String) -> IpamIpAddressesCreateRequest {
