...
impl ModuleType {
    ...
    pub fn new(id: i32, url: String, display_url: String, display: String, manufacturer: crate::models::BriefManufacturer, model: String, created: Option<String>, last_updated: Option<String>) -> ModuleType {
        ModuleType {
            id,
            url,
            display_url,
