...
impl WritableWirelessLinkRequest {
    ...
    pub fn new(interface_a: crate::models::PatchedWritableVirtualCircuitTerminationRequestInterface, interface_b: crate::models::PatchedWritableVirtualCircuitTerminationRequestInterface) -> WritableWirelessLinkRequest {
