...
impl MacAddress {
    ...
    pub fn new(id: i32, url: String, display_url: String, display: String, mac_address: String, assigned_object: Option<serde_json::Value>, created: Option<String>, last_updated: Option<String>) -> MacAddress {
        MacAddress {
            id,
            url,
            display_url,
