...
impl FrontPortRequest {
    ...
    pub fn new(device: crate::models::BriefInterfaceRequestDevice, name: String, r#type: RHashType, rear_port: crate::models::FrontPortRearPortRequest) -> FrontPortRequest {
        FrontPortRequest {
