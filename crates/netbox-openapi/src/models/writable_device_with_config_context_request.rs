...
pub struct WritableDeviceWithConfigContextRequest {
    ...
    #[serde(rename = "role")]
    pub role: Box<crate::models::DeviceWithConfigContextRequestRole>,
    ...
    #[serde(rename = "face", default, with = "::serde_with::rust::double_option", skip_serializing_if = "Option::is_none")]
    ...
    pub oob_ip: Option<Option<Box<crate::models::DeviceWithConfigContextRequestPrimaryIp4>>>,
    ...
    pub virtual_chassis: Option<Option<Box<crate::models::DeviceWithConfigContextRequestVirtualChassis>>>,
...
impl WritableDeviceWithConfigContextRequest {
    ...
    pub fn new(device_type: crate::models::DeviceBayTemplateRequestDeviceType, role: crate::models::DeviceWithConfigContextRequestRole, site: crate::models::DeviceWithConfigContextRequestSite) -> WritableDeviceWithConfigContextRequest {
