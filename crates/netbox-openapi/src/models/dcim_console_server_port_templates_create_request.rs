...
pub struct DcimConsoleServerPortTemplatesCreateRequest {
    #[serde(
        rename = "device_type",
        default,
...
impl DcimConsoleServerPortTemplatesCreateRequest {
    pub fn new(name: String) -> DcimConsoleServerPortTemplatesCreateRequest {
