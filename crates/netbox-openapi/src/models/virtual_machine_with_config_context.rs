...
impl VirtualMachineWithConfigContext {
    ...
    pub fn new(id: i32, url: String, display_url: String, display: String, name: String, primary_ip: Option<crate::models::BriefIpAddress>, config_context: Option<serde_json::Value>, created: Option<String>, last_updated: Option<String>, interface_count: i32, virtual_disk_count: i32) -> VirtualMachineWithConfigContext {
