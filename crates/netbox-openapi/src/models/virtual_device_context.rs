...
impl VirtualDeviceContext {
    ...
    pub fn new(id: i32, url: String, display_url: String, display: String, name: String, device: crate::models::BriefDevice, primary_ip: Option<crate::models::BriefIpAddress>, status: crate::models::VirtualDeviceContextStatus, created: Option<String>, last_updated: Option<String>, interface_count: i64) -> VirtualDeviceContext {
