...
impl InventoryItem {
    ...
    pub fn new(id: i32, url: String, display_url: String, display: String, device: crate::models::BriefDevice, name: String, component: Option<serde_json::Value>, created: Option<String>, last_updated: Option<String>, _depth: i32) -> InventoryItem {
        InventoryItem {
            id,
            url,
            display_url,
