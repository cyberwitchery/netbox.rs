...
pub struct Tag {
    ...
    #[serde(rename = "tagged_items", default)]
...
impl Tag {
    ...
    pub fn new(id: i32, url: String, display_url: String, display: String, name: String, slug: String, tagged_items: i64, created: Option<String>, last_updated: Option<String>) -> Tag {
        Tag {
            id,
            url,
            display_url,
