...
pub struct WritableContactAssignmentRequest {
    ...
    pub contact: Box<crate::models::ContactAssignmentRequestContact>,
...
impl WritableContactAssignmentRequest {
    ...
    pub fn new(object_type: String, object_id: i64, contact: crate::models::ContactAssignmentRequestContact) -> WritableContactAssignmentRequest {
