...
impl Aggregate {
    ...
    pub fn new(id: i32, url: String, display_url: String, display: String, family: crate::models::AggregateFamily, prefix: String, rir: crate::models::BriefRir, created: Option<String>, last_updated: Option<String>) -> Aggregate {
        Aggregate {
            id,
            url,
            display_url,
