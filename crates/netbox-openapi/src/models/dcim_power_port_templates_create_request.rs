...
pub struct DcimPowerPortTemplatesCreateRequest {
    #[serde(
        rename = "device_type",
        default,
...
impl DcimPowerPortTemplatesCreateRequest {
    pub fn new(name: String) -> DcimPowerPortTemplatesCreateRequest {
