...
impl DeviceRole {
    ...
    pub fn new(id: i32, url: String, display_url: String, display: String, name: String, slug: String, created: Option<String>, last_updated: Option<String>, device_count: i32, virtualmachine_count: i32, _depth: i32) -> DeviceRole {
        DeviceRole {
            id,
            url,
            display_url,
