...
pub struct DcimFrontPortTemplatesCreateRequest {
    #[serde(
        rename = "device_type",
        default,
    ...
    pub rear_ports: Option<Vec<crate::models::FrontPortTemplateMappingRequest>>,
    #[serde(rename = "description", skip_serializing_if = "Option::is_none")]
    pub description: Option<String>,
}

impl DcimFrontPortTemplatesCreateRequest {
    pub fn new(name: String, r#type: RHashType) -> DcimFrontPortTemplatesCreateRequest {
