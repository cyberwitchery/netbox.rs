...
pub struct WritableRackRequest {
    ...
    pub role: Option<Option<Box<crate::models::PatchedWritableRackRequestRole>>>,
    ...
    #[serde(rename = "rack_type", default, with = "::serde_with::rust::double_option", skip_serializing_if = "Option::is_none")]
    pub rack_type: Option<Option<Box<crate::models::PatchedWritableRackRequestRackType>>>,
    ...
    #[serde(rename = "form_factor", default, with = "::serde_with::rust::double_option", skip_serializing_if = "Option::is_none")]
    ...
    #[serde(rename = "outer_height", default, with = "::serde_with::rust::double_option", skip_serializing_if = "Option::is_none")]
...
impl WritableRackRequest {
    ...
    pub fn new(name: String, site: crate::models::DeviceWithConfigContextRequestSite) -> WritableRackRequest {
        WritableRackRequest {
            name,
            facility_id: None,
            site: Box::new(site),
