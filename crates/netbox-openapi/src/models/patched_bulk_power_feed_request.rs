...
pub struct PatchedBulkPowerFeedRequest {
    #[serde(rename = "id")]
    pub id: i32,
    #[serde(rename = "power_panel", skip_serializing_if = "Option::is_none")]
    pub power_panel: Option<Box<crate::models::BulkPowerFeedRequestPowerPanel>>,
    #[serde(
        rename = "rack",
        default,
...
impl PatchedBulkPowerFeedRequest {
    /// Base serializer class for models inheriting from PrimaryModel.
    pub fn new(id: i32) -> PatchedBulkPowerFeedRequest {
