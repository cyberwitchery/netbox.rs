...
pub struct DcimRearPortTemplatesCreateRequest {
    #[serde(
        rename = "device_type",
        default,
    ...
    #[serde(rename = "front_ports", skip_serializing_if = "Option::is_none")]
    pub front_ports: Option<Vec<crate::models::RearPortTemplateMappingRequest>>,
    #[serde(rename = "description", skip_serializing_if = "Option::is_none")]
    pub description: Option<String>,
}

impl DcimRearPortTemplatesCreateRequest {
    pub fn new(name: String, r#type: RHashType) -> DcimRearPortTemplatesCreateRequest {
