...
impl FrontPort {
    ...
    pub fn new(id: i32, url: String, display_url: String, display: String, device: crate::models::BriefDevice, name: String, r#type: crate::models::FrontPortType, rear_port: crate::models::FrontPortRearPort, cable: Option<crate::models::BriefCable>, cable_end: String, link_peers: Vec<serde_json::Value>, link_peers_type: Option<String>, created: Option<String>, last_updated: Option<String>, _occupied: bool) -> FrontPort {
        FrontPort {
            id,
            url,
            display_url,
