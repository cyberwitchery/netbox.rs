...
pub struct NestedCoolingOutflowRequest {
    #[serde(rename = "name")]
    pub name: String,
}

impl NestedCoolingOutflowRequest {
    ...
    pub fn new(name: String) -> NestedCoolingOutflowRequest {
        NestedCoolingOutflowRequest { name }
    }
}
